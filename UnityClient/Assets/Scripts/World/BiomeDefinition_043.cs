namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #043
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_043", menuName = "RelicRun/World/Biome Definition #043")]
    public class BiomeDefinition_043 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_043";
        [SerializeField] private string displayName = "Biome Zone #043";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (43 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (43 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 43 * 500;
