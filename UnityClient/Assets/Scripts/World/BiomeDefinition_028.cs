namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #028
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_028", menuName = "RelicRun/World/Biome Definition #028")]
    public class BiomeDefinition_028 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_028";
        [SerializeField] private string displayName = "Biome Zone #028";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (28 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (28 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 28 * 500;
