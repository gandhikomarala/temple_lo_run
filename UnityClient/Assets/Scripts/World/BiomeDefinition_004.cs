namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #004
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_004", menuName = "RelicRun/World/Biome Definition #004")]
    public class BiomeDefinition_004 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_004";
        [SerializeField] private string displayName = "Biome Zone #004";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (4 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (4 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 4 * 500;
