namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #082
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_082", menuName = "RelicRun/World/Biome Definition #082")]
    public class BiomeDefinition_082 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_082";
        [SerializeField] private string displayName = "Biome Zone #082";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (82 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (82 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 82 * 500;
