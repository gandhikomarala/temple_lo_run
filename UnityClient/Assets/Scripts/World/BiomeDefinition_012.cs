namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #012
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_012", menuName = "RelicRun/World/Biome Definition #012")]
    public class BiomeDefinition_012 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_012";
        [SerializeField] private string displayName = "Biome Zone #012";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (12 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (12 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 12 * 500;
