namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #084
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_084", menuName = "RelicRun/World/Biome Definition #084")]
    public class BiomeDefinition_084 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_084";
        [SerializeField] private string displayName = "Biome Zone #084";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (84 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (84 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 84 * 500;
