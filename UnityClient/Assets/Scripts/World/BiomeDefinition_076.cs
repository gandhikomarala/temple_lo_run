namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #076
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_076", menuName = "RelicRun/World/Biome Definition #076")]
    public class BiomeDefinition_076 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_076";
        [SerializeField] private string displayName = "Biome Zone #076";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (76 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (76 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 76 * 500;
