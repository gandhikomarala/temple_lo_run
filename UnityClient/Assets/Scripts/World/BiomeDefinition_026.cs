namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #026
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_026", menuName = "RelicRun/World/Biome Definition #026")]
    public class BiomeDefinition_026 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_026";
        [SerializeField] private string displayName = "Biome Zone #026";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (26 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (26 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 26 * 500;
