namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #038
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_038", menuName = "RelicRun/World/Biome Definition #038")]
    public class BiomeDefinition_038 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_038";
        [SerializeField] private string displayName = "Biome Zone #038";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (38 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (38 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 38 * 500;
