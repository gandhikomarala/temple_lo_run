namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #100
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_100", menuName = "RelicRun/World/Biome Definition #100")]
    public class BiomeDefinition_100 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_100";
        [SerializeField] private string displayName = "Biome Zone #100";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (100 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (100 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 100 * 500;
