namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #052
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_052", menuName = "RelicRun/World/Biome Definition #052")]
    public class BiomeDefinition_052 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_052";
        [SerializeField] private string displayName = "Biome Zone #052";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (52 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (52 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 52 * 500;
