namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #089
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_089", menuName = "RelicRun/World/Biome Definition #089")]
    public class BiomeDefinition_089 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_089";
        [SerializeField] private string displayName = "Biome Zone #089";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (89 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (89 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 89 * 500;
