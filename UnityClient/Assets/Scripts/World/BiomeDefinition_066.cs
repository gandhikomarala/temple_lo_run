namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #066
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_066", menuName = "RelicRun/World/Biome Definition #066")]
    public class BiomeDefinition_066 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_066";
        [SerializeField] private string displayName = "Biome Zone #066";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (66 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (66 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 66 * 500;
