namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #096
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_096", menuName = "RelicRun/World/Biome Definition #096")]
    public class BiomeDefinition_096 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_096";
        [SerializeField] private string displayName = "Biome Zone #096";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (96 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (96 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 96 * 500;
