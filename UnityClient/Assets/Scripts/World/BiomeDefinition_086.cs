namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #086
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_086", menuName = "RelicRun/World/Biome Definition #086")]
    public class BiomeDefinition_086 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_086";
        [SerializeField] private string displayName = "Biome Zone #086";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (86 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (86 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 86 * 500;
