namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #062
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_062", menuName = "RelicRun/World/Biome Definition #062")]
    public class BiomeDefinition_062 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_062";
        [SerializeField] private string displayName = "Biome Zone #062";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (62 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (62 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 62 * 500;
