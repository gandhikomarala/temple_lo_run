namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #061
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_061", menuName = "RelicRun/World/Biome Definition #061")]
    public class BiomeDefinition_061 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_061";
        [SerializeField] private string displayName = "Biome Zone #061";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (61 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (61 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 61 * 500;
