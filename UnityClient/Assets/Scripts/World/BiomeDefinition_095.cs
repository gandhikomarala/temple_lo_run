namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #095
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_095", menuName = "RelicRun/World/Biome Definition #095")]
    public class BiomeDefinition_095 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_095";
        [SerializeField] private string displayName = "Biome Zone #095";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (95 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (95 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 95 * 500;
