namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #006
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_006", menuName = "RelicRun/World/Biome Definition #006")]
    public class BiomeDefinition_006 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_006";
        [SerializeField] private string displayName = "Biome Zone #006";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (6 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (6 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 6 * 500;
