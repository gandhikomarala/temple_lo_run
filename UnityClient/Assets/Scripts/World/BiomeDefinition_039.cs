namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #039
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_039", menuName = "RelicRun/World/Biome Definition #039")]
    public class BiomeDefinition_039 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_039";
        [SerializeField] private string displayName = "Biome Zone #039";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (39 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (39 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 39 * 500;
