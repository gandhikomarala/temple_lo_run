namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #057
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_057", menuName = "RelicRun/World/Biome Definition #057")]
    public class BiomeDefinition_057 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_057";
        [SerializeField] private string displayName = "Biome Zone #057";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (57 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (57 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 57 * 500;
