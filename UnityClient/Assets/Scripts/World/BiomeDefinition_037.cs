namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #037
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_037", menuName = "RelicRun/World/Biome Definition #037")]
    public class BiomeDefinition_037 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_037";
        [SerializeField] private string displayName = "Biome Zone #037";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (37 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (37 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 37 * 500;
