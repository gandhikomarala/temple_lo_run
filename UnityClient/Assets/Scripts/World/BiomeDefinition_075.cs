namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #075
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_075", menuName = "RelicRun/World/Biome Definition #075")]
    public class BiomeDefinition_075 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_075";
        [SerializeField] private string displayName = "Biome Zone #075";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (75 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (75 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 75 * 500;
