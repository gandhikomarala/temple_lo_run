namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #014
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_014", menuName = "RelicRun/World/Biome Definition #014")]
    public class BiomeDefinition_014 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_014";
        [SerializeField] private string displayName = "Biome Zone #014";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (14 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (14 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 14 * 500;
