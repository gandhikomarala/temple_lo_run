namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #064
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_064", menuName = "RelicRun/World/Biome Definition #064")]
    public class BiomeDefinition_064 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_064";
        [SerializeField] private string displayName = "Biome Zone #064";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (64 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (64 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 64 * 500;
