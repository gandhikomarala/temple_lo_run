namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #085
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_085", menuName = "RelicRun/World/Biome Definition #085")]
    public class BiomeDefinition_085 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_085";
        [SerializeField] private string displayName = "Biome Zone #085";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (85 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (85 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 85 * 500;
