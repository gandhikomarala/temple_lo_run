namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #065
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_065", menuName = "RelicRun/World/Biome Definition #065")]
    public class BiomeDefinition_065 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_065";
        [SerializeField] private string displayName = "Biome Zone #065";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (65 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (65 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 65 * 500;
