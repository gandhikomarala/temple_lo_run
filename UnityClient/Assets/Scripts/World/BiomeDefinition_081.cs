namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #081
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_081", menuName = "RelicRun/World/Biome Definition #081")]
    public class BiomeDefinition_081 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_081";
        [SerializeField] private string displayName = "Biome Zone #081";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (81 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (81 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 81 * 500;
