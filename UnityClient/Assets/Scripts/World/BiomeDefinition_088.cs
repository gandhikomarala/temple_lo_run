namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #088
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_088", menuName = "RelicRun/World/Biome Definition #088")]
    public class BiomeDefinition_088 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_088";
        [SerializeField] private string displayName = "Biome Zone #088";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (88 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (88 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 88 * 500;
