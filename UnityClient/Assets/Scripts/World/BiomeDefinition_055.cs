namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #055
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_055", menuName = "RelicRun/World/Biome Definition #055")]
    public class BiomeDefinition_055 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_055";
        [SerializeField] private string displayName = "Biome Zone #055";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (55 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (55 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 55 * 500;
