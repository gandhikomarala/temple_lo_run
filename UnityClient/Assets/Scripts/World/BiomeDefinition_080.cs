namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #080
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_080", menuName = "RelicRun/World/Biome Definition #080")]
    public class BiomeDefinition_080 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_080";
        [SerializeField] private string displayName = "Biome Zone #080";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (80 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (80 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 80 * 500;
