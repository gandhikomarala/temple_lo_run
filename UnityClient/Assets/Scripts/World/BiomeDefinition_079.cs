namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #079
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_079", menuName = "RelicRun/World/Biome Definition #079")]
    public class BiomeDefinition_079 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_079";
        [SerializeField] private string displayName = "Biome Zone #079";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (79 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (79 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 79 * 500;
