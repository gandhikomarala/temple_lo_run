namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #044
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_044", menuName = "RelicRun/World/Biome Definition #044")]
    public class BiomeDefinition_044 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_044";
        [SerializeField] private string displayName = "Biome Zone #044";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (44 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (44 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 44 * 500;
