namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #091
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_091", menuName = "RelicRun/World/Biome Definition #091")]
    public class BiomeDefinition_091 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_091";
        [SerializeField] private string displayName = "Biome Zone #091";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (91 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (91 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 91 * 500;
