namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #045
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_045", menuName = "RelicRun/World/Biome Definition #045")]
    public class BiomeDefinition_045 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_045";
        [SerializeField] private string displayName = "Biome Zone #045";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (45 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (45 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 45 * 500;
