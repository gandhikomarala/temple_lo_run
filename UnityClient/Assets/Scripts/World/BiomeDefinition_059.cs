namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #059
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_059", menuName = "RelicRun/World/Biome Definition #059")]
    public class BiomeDefinition_059 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_059";
        [SerializeField] private string displayName = "Biome Zone #059";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (59 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (59 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 59 * 500;
