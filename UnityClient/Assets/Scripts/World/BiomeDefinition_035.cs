namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #035
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_035", menuName = "RelicRun/World/Biome Definition #035")]
    public class BiomeDefinition_035 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_035";
        [SerializeField] private string displayName = "Biome Zone #035";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (35 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (35 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 35 * 500;
