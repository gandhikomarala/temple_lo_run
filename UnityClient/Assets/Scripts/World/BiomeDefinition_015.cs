namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #015
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_015", menuName = "RelicRun/World/Biome Definition #015")]
    public class BiomeDefinition_015 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_015";
        [SerializeField] private string displayName = "Biome Zone #015";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (15 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (15 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 15 * 500;
