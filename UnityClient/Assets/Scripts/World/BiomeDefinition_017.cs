namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #017
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_017", menuName = "RelicRun/World/Biome Definition #017")]
    public class BiomeDefinition_017 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_017";
        [SerializeField] private string displayName = "Biome Zone #017";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (17 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (17 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 17 * 500;
