namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #074
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_074", menuName = "RelicRun/World/Biome Definition #074")]
    public class BiomeDefinition_074 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_074";
        [SerializeField] private string displayName = "Biome Zone #074";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (74 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (74 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 74 * 500;
