namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #033
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_033", menuName = "RelicRun/World/Biome Definition #033")]
    public class BiomeDefinition_033 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_033";
        [SerializeField] private string displayName = "Biome Zone #033";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (33 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (33 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 33 * 500;
