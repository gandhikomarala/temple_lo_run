namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #050
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_050", menuName = "RelicRun/World/Biome Definition #050")]
    public class BiomeDefinition_050 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_050";
        [SerializeField] private string displayName = "Biome Zone #050";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (50 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (50 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 50 * 500;
