namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #046
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_046", menuName = "RelicRun/World/Biome Definition #046")]
    public class BiomeDefinition_046 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_046";
        [SerializeField] private string displayName = "Biome Zone #046";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (46 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (46 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 46 * 500;
