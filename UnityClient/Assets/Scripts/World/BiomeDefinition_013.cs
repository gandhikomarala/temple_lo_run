namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #013
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_013", menuName = "RelicRun/World/Biome Definition #013")]
    public class BiomeDefinition_013 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_013";
        [SerializeField] private string displayName = "Biome Zone #013";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (13 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (13 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 13 * 500;
