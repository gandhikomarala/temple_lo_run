namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #032
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_032", menuName = "RelicRun/World/Biome Definition #032")]
    public class BiomeDefinition_032 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_032";
        [SerializeField] private string displayName = "Biome Zone #032";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (32 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (32 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 32 * 500;
