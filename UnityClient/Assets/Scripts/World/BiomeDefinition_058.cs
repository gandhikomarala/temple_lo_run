namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #058
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_058", menuName = "RelicRun/World/Biome Definition #058")]
    public class BiomeDefinition_058 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_058";
        [SerializeField] private string displayName = "Biome Zone #058";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (58 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (58 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 58 * 500;
