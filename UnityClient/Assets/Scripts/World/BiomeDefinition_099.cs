namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #099
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_099", menuName = "RelicRun/World/Biome Definition #099")]
    public class BiomeDefinition_099 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_099";
        [SerializeField] private string displayName = "Biome Zone #099";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (99 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (99 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 99 * 500;
