namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #092
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_092", menuName = "RelicRun/World/Biome Definition #092")]
    public class BiomeDefinition_092 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_092";
        [SerializeField] private string displayName = "Biome Zone #092";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (92 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (92 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 92 * 500;
