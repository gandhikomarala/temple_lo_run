namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #053
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_053", menuName = "RelicRun/World/Biome Definition #053")]
    public class BiomeDefinition_053 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_053";
        [SerializeField] private string displayName = "Biome Zone #053";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (53 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (53 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 53 * 500;
