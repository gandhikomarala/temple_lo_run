namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #051
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_051", menuName = "RelicRun/World/Biome Definition #051")]
    public class BiomeDefinition_051 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_051";
        [SerializeField] private string displayName = "Biome Zone #051";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (51 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (51 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 51 * 500;
