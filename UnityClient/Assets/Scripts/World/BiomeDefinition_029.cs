namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #029
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_029", menuName = "RelicRun/World/Biome Definition #029")]
    public class BiomeDefinition_029 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_029";
        [SerializeField] private string displayName = "Biome Zone #029";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (29 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (29 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 29 * 500;
