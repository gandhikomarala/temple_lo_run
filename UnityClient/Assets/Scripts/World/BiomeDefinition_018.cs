namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #018
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_018", menuName = "RelicRun/World/Biome Definition #018")]
    public class BiomeDefinition_018 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_018";
        [SerializeField] private string displayName = "Biome Zone #018";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (18 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (18 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 18 * 500;
