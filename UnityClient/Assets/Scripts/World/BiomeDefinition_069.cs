namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #069
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_069", menuName = "RelicRun/World/Biome Definition #069")]
    public class BiomeDefinition_069 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_069";
        [SerializeField] private string displayName = "Biome Zone #069";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (69 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (69 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 69 * 500;
