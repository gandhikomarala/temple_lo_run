namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #024
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_024", menuName = "RelicRun/World/Biome Definition #024")]
    public class BiomeDefinition_024 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_024";
        [SerializeField] private string displayName = "Biome Zone #024";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (24 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (24 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 24 * 500;
