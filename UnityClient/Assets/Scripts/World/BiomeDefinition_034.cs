namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #034
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_034", menuName = "RelicRun/World/Biome Definition #034")]
    public class BiomeDefinition_034 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_034";
        [SerializeField] private string displayName = "Biome Zone #034";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (34 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (34 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 34 * 500;
