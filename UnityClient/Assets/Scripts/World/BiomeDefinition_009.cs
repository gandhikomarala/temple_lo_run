namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #009
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_009", menuName = "RelicRun/World/Biome Definition #009")]
    public class BiomeDefinition_009 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_009";
        [SerializeField] private string displayName = "Biome Zone #009";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (9 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (9 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 9 * 500;
