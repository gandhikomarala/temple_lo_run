namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #021
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_021", menuName = "RelicRun/World/Biome Definition #021")]
    public class BiomeDefinition_021 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_021";
        [SerializeField] private string displayName = "Biome Zone #021";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (21 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (21 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 21 * 500;
