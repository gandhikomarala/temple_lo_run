namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #025
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_025", menuName = "RelicRun/World/Biome Definition #025")]
    public class BiomeDefinition_025 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_025";
        [SerializeField] private string displayName = "Biome Zone #025";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (25 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (25 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 25 * 500;
