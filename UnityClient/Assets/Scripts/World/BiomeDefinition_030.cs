namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #030
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_030", menuName = "RelicRun/World/Biome Definition #030")]
    public class BiomeDefinition_030 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_030";
        [SerializeField] private string displayName = "Biome Zone #030";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (30 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (30 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 30 * 500;
