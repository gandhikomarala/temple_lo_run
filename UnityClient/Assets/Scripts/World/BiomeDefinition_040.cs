namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #040
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_040", menuName = "RelicRun/World/Biome Definition #040")]
    public class BiomeDefinition_040 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_040";
        [SerializeField] private string displayName = "Biome Zone #040";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (40 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (40 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 40 * 500;
