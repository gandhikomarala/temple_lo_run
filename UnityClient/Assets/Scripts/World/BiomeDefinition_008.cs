namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #008
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_008", menuName = "RelicRun/World/Biome Definition #008")]
    public class BiomeDefinition_008 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_008";
        [SerializeField] private string displayName = "Biome Zone #008";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (8 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (8 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 8 * 500;
