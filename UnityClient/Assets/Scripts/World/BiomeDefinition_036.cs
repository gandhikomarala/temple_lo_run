namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #036
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_036", menuName = "RelicRun/World/Biome Definition #036")]
    public class BiomeDefinition_036 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_036";
        [SerializeField] private string displayName = "Biome Zone #036";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (36 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (36 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 36 * 500;
