namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #016
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_016", menuName = "RelicRun/World/Biome Definition #016")]
    public class BiomeDefinition_016 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_016";
        [SerializeField] private string displayName = "Biome Zone #016";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (16 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (16 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 16 * 500;
