namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #005
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_005", menuName = "RelicRun/World/Biome Definition #005")]
    public class BiomeDefinition_005 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_005";
        [SerializeField] private string displayName = "Biome Zone #005";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (5 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (5 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 5 * 500;
