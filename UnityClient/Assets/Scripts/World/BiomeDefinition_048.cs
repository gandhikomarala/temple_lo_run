namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #048
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_048", menuName = "RelicRun/World/Biome Definition #048")]
    public class BiomeDefinition_048 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_048";
        [SerializeField] private string displayName = "Biome Zone #048";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (48 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (48 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 48 * 500;
