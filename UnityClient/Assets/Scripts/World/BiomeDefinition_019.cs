namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #019
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_019", menuName = "RelicRun/World/Biome Definition #019")]
    public class BiomeDefinition_019 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_019";
        [SerializeField] private string displayName = "Biome Zone #019";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (19 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (19 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 19 * 500;
