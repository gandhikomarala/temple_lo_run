namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #031
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_031", menuName = "RelicRun/World/Biome Definition #031")]
    public class BiomeDefinition_031 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_031";
        [SerializeField] private string displayName = "Biome Zone #031";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (31 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (31 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 31 * 500;
