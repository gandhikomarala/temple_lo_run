namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #001
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_001", menuName = "RelicRun/World/Biome Definition #001")]
    public class BiomeDefinition_001 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_001";
        [SerializeField] private string displayName = "Biome Zone #001";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (1 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (1 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 1 * 500;
