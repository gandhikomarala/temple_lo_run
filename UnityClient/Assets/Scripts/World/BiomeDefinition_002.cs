namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #002
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_002", menuName = "RelicRun/World/Biome Definition #002")]
    public class BiomeDefinition_002 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_002";
        [SerializeField] private string displayName = "Biome Zone #002";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (2 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (2 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 2 * 500;
