namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #090
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_090", menuName = "RelicRun/World/Biome Definition #090")]
    public class BiomeDefinition_090 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_090";
        [SerializeField] private string displayName = "Biome Zone #090";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (90 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (90 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 90 * 500;
