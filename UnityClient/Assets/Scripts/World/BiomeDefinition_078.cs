namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #078
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_078", menuName = "RelicRun/World/Biome Definition #078")]
    public class BiomeDefinition_078 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_078";
        [SerializeField] private string displayName = "Biome Zone #078";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (78 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (78 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 78 * 500;
