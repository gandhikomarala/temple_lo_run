namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #087
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_087", menuName = "RelicRun/World/Biome Definition #087")]
    public class BiomeDefinition_087 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_087";
        [SerializeField] private string displayName = "Biome Zone #087";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (87 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (87 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 87 * 500;
