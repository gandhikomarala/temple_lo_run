namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #098
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_098", menuName = "RelicRun/World/Biome Definition #098")]
    public class BiomeDefinition_098 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_098";
        [SerializeField] private string displayName = "Biome Zone #098";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (98 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (98 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 98 * 500;
