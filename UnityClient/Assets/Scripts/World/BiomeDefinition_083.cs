namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #083
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_083", menuName = "RelicRun/World/Biome Definition #083")]
    public class BiomeDefinition_083 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_083";
        [SerializeField] private string displayName = "Biome Zone #083";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (83 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (83 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 83 * 500;
