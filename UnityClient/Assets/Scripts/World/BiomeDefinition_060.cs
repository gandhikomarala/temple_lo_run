namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #060
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_060", menuName = "RelicRun/World/Biome Definition #060")]
    public class BiomeDefinition_060 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_060";
        [SerializeField] private string displayName = "Biome Zone #060";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (60 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (60 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 60 * 500;
