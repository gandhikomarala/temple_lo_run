namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #049
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_049", menuName = "RelicRun/World/Biome Definition #049")]
    public class BiomeDefinition_049 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_049";
        [SerializeField] private string displayName = "Biome Zone #049";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (49 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (49 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 49 * 500;
