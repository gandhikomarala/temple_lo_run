namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #071
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_071", menuName = "RelicRun/World/Biome Definition #071")]
    public class BiomeDefinition_071 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_071";
        [SerializeField] private string displayName = "Biome Zone #071";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (71 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (71 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 71 * 500;
