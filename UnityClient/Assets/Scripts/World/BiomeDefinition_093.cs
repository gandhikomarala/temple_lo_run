namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #093
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_093", menuName = "RelicRun/World/Biome Definition #093")]
    public class BiomeDefinition_093 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_093";
        [SerializeField] private string displayName = "Biome Zone #093";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (93 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (93 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 93 * 500;
