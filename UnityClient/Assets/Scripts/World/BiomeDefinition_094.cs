namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #094
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_094", menuName = "RelicRun/World/Biome Definition #094")]
    public class BiomeDefinition_094 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_094";
        [SerializeField] private string displayName = "Biome Zone #094";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (94 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (94 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 94 * 500;
