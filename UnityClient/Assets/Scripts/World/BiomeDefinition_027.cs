namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #027
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_027", menuName = "RelicRun/World/Biome Definition #027")]
    public class BiomeDefinition_027 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_027";
        [SerializeField] private string displayName = "Biome Zone #027";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (27 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (27 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 27 * 500;
