namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #041
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_041", menuName = "RelicRun/World/Biome Definition #041")]
    public class BiomeDefinition_041 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_041";
        [SerializeField] private string displayName = "Biome Zone #041";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (41 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (41 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 41 * 500;
