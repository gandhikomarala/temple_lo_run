namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #020
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_020", menuName = "RelicRun/World/Biome Definition #020")]
    public class BiomeDefinition_020 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_020";
        [SerializeField] private string displayName = "Biome Zone #020";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (20 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (20 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 20 * 500;
