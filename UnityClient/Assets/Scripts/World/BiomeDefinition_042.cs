namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #042
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_042", menuName = "RelicRun/World/Biome Definition #042")]
    public class BiomeDefinition_042 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_042";
        [SerializeField] private string displayName = "Biome Zone #042";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (42 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (42 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 42 * 500;
