namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #067
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_067", menuName = "RelicRun/World/Biome Definition #067")]
    public class BiomeDefinition_067 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_067";
        [SerializeField] private string displayName = "Biome Zone #067";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (67 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (67 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 67 * 500;
