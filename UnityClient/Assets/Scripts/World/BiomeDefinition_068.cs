namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #068
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_068", menuName = "RelicRun/World/Biome Definition #068")]
    public class BiomeDefinition_068 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_068";
        [SerializeField] private string displayName = "Biome Zone #068";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (68 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (68 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 68 * 500;
