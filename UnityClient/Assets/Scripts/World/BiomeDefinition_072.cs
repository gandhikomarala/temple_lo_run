namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #072
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_072", menuName = "RelicRun/World/Biome Definition #072")]
    public class BiomeDefinition_072 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_072";
        [SerializeField] private string displayName = "Biome Zone #072";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (72 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (72 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 72 * 500;
