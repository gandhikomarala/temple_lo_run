namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #011
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_011", menuName = "RelicRun/World/Biome Definition #011")]
    public class BiomeDefinition_011 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_011";
        [SerializeField] private string displayName = "Biome Zone #011";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (11 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (11 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 11 * 500;
