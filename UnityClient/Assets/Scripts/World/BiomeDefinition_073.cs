namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #073
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_073", menuName = "RelicRun/World/Biome Definition #073")]
    public class BiomeDefinition_073 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_073";
        [SerializeField] private string displayName = "Biome Zone #073";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (73 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (73 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 73 * 500;
