namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #070
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_070", menuName = "RelicRun/World/Biome Definition #070")]
    public class BiomeDefinition_070 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_070";
        [SerializeField] private string displayName = "Biome Zone #070";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (70 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (70 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 70 * 500;
