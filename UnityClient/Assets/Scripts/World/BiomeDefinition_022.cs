namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #022
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_022", menuName = "RelicRun/World/Biome Definition #022")]
    public class BiomeDefinition_022 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_022";
        [SerializeField] private string displayName = "Biome Zone #022";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (22 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (22 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 22 * 500;
