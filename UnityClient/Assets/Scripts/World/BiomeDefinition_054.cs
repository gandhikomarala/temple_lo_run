namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #054
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_054", menuName = "RelicRun/World/Biome Definition #054")]
    public class BiomeDefinition_054 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_054";
        [SerializeField] private string displayName = "Biome Zone #054";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (54 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (54 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 54 * 500;
