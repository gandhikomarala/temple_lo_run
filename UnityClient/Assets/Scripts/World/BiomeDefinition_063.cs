namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #063
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_063", menuName = "RelicRun/World/Biome Definition #063")]
    public class BiomeDefinition_063 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_063";
        [SerializeField] private string displayName = "Biome Zone #063";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (63 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (63 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 63 * 500;
