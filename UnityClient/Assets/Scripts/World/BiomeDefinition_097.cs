namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #097
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_097", menuName = "RelicRun/World/Biome Definition #097")]
    public class BiomeDefinition_097 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_097";
        [SerializeField] private string displayName = "Biome Zone #097";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (97 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (97 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 97 * 500;
