namespace RelicRun.World
{
    ...
    /// <summary>
    /// Biome Definition & Environmental Ruleset #010
    /// Controls atmospheric fog, dynamic lighting presets, obstacle weights, and ambient audio loops.
    /// </summary>
    [CreateAssetMenu(fileName = "BiomeDefinition_010", menuName = "RelicRun/World/Biome Definition #010")]
    public class BiomeDefinition_010 : ScriptableObject
    {
        [Header("Biome Identity")]
        [SerializeField] private string biomeId = "BIOME_010";
        [SerializeField] private string displayName = "Biome Zone #010";
        ...
        [SerializeField] private float obstacleDensityMultiplier = 1.0f + (10 * 0.01f);
        [SerializeField] private float speedMultiplier = 1.0f + (10 * 0.005f);
        [SerializeField] private int minMetersToUnlock = 10 * 500;
