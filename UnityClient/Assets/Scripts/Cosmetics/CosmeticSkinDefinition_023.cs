namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #023
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_023", menuName = "RelicRun/Cosmetics/Skin #023")]
    public class CosmeticSkinDefinition_023 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_023";
        [SerializeField] private string outfitName = "Adventurer Outfit #023";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (23 * 50);
        [SerializeField] private int requiredDistanceMeters = 23 * 800;
