namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #017
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_017", menuName = "RelicRun/Cosmetics/Skin #017")]
    public class CosmeticSkinDefinition_017 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_017";
        [SerializeField] private string outfitName = "Adventurer Outfit #017";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (17 * 50);
        [SerializeField] private int requiredDistanceMeters = 17 * 800;
