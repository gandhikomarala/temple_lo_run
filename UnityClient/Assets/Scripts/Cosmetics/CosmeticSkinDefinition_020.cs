namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #020
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_020", menuName = "RelicRun/Cosmetics/Skin #020")]
    public class CosmeticSkinDefinition_020 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_020";
        [SerializeField] private string outfitName = "Adventurer Outfit #020";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (20 * 50);
        [SerializeField] private int requiredDistanceMeters = 20 * 800;
