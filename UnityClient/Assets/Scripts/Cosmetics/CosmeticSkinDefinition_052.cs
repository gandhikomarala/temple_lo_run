namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #052
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_052", menuName = "RelicRun/Cosmetics/Skin #052")]
    public class CosmeticSkinDefinition_052 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_052";
        [SerializeField] private string outfitName = "Adventurer Outfit #052";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (52 * 50);
        [SerializeField] private int requiredDistanceMeters = 52 * 800;
