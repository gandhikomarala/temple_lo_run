namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #126
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_126", menuName = "RelicRun/Cosmetics/Skin #126")]
    public class CosmeticSkinDefinition_126 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_126";
        [SerializeField] private string outfitName = "Adventurer Outfit #126";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (126 * 50);
        [SerializeField] private int requiredDistanceMeters = 126 * 800;
