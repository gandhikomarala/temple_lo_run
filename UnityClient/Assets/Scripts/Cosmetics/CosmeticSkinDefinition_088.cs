namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #088
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_088", menuName = "RelicRun/Cosmetics/Skin #088")]
    public class CosmeticSkinDefinition_088 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_088";
        [SerializeField] private string outfitName = "Adventurer Outfit #088";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (88 * 50);
        [SerializeField] private int requiredDistanceMeters = 88 * 800;
