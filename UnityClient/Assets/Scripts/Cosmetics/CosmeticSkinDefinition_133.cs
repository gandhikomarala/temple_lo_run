namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #133
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_133", menuName = "RelicRun/Cosmetics/Skin #133")]
    public class CosmeticSkinDefinition_133 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_133";
        [SerializeField] private string outfitName = "Adventurer Outfit #133";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (133 * 50);
        [SerializeField] private int requiredDistanceMeters = 133 * 800;
