namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #122
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_122", menuName = "RelicRun/Cosmetics/Skin #122")]
    public class CosmeticSkinDefinition_122 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_122";
        [SerializeField] private string outfitName = "Adventurer Outfit #122";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (122 * 50);
        [SerializeField] private int requiredDistanceMeters = 122 * 800;
