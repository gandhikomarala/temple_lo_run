namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #012
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_012", menuName = "RelicRun/Cosmetics/Skin #012")]
    public class CosmeticSkinDefinition_012 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_012";
        [SerializeField] private string outfitName = "Adventurer Outfit #012";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (12 * 50);
        [SerializeField] private int requiredDistanceMeters = 12 * 800;
