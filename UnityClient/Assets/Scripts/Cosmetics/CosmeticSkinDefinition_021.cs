namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #021
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_021", menuName = "RelicRun/Cosmetics/Skin #021")]
    public class CosmeticSkinDefinition_021 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_021";
        [SerializeField] private string outfitName = "Adventurer Outfit #021";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (21 * 50);
        [SerializeField] private int requiredDistanceMeters = 21 * 800;
