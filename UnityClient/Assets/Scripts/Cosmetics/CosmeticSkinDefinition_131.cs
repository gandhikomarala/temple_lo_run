namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #131
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_131", menuName = "RelicRun/Cosmetics/Skin #131")]
    public class CosmeticSkinDefinition_131 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_131";
        [SerializeField] private string outfitName = "Adventurer Outfit #131";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (131 * 50);
        [SerializeField] private int requiredDistanceMeters = 131 * 800;
