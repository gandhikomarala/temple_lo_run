namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #086
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_086", menuName = "RelicRun/Cosmetics/Skin #086")]
    public class CosmeticSkinDefinition_086 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_086";
        [SerializeField] private string outfitName = "Adventurer Outfit #086";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (86 * 50);
        [SerializeField] private int requiredDistanceMeters = 86 * 800;
