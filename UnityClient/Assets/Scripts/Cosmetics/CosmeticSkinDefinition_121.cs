namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #121
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_121", menuName = "RelicRun/Cosmetics/Skin #121")]
    public class CosmeticSkinDefinition_121 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_121";
        [SerializeField] private string outfitName = "Adventurer Outfit #121";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (121 * 50);
        [SerializeField] private int requiredDistanceMeters = 121 * 800;
