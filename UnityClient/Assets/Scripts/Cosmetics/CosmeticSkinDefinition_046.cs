namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #046
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_046", menuName = "RelicRun/Cosmetics/Skin #046")]
    public class CosmeticSkinDefinition_046 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_046";
        [SerializeField] private string outfitName = "Adventurer Outfit #046";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (46 * 50);
        [SerializeField] private int requiredDistanceMeters = 46 * 800;
