namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #005
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_005", menuName = "RelicRun/Cosmetics/Skin #005")]
    public class CosmeticSkinDefinition_005 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_005";
        [SerializeField] private string outfitName = "Adventurer Outfit #005";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (5 * 50);
        [SerializeField] private int requiredDistanceMeters = 5 * 800;
