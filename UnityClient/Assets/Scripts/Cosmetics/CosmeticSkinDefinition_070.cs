namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #070
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_070", menuName = "RelicRun/Cosmetics/Skin #070")]
    public class CosmeticSkinDefinition_070 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_070";
        [SerializeField] private string outfitName = "Adventurer Outfit #070";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (70 * 50);
        [SerializeField] private int requiredDistanceMeters = 70 * 800;
