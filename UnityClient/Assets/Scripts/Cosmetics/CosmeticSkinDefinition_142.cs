namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #142
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_142", menuName = "RelicRun/Cosmetics/Skin #142")]
    public class CosmeticSkinDefinition_142 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_142";
        [SerializeField] private string outfitName = "Adventurer Outfit #142";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (142 * 50);
        [SerializeField] private int requiredDistanceMeters = 142 * 800;
