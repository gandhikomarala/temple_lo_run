namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #141
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_141", menuName = "RelicRun/Cosmetics/Skin #141")]
    public class CosmeticSkinDefinition_141 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_141";
        [SerializeField] private string outfitName = "Adventurer Outfit #141";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (141 * 50);
        [SerializeField] private int requiredDistanceMeters = 141 * 800;
