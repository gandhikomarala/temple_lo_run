namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #039
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_039", menuName = "RelicRun/Cosmetics/Skin #039")]
    public class CosmeticSkinDefinition_039 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_039";
        [SerializeField] private string outfitName = "Adventurer Outfit #039";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (39 * 50);
        [SerializeField] private int requiredDistanceMeters = 39 * 800;
