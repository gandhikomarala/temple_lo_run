namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #007
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_007", menuName = "RelicRun/Cosmetics/Skin #007")]
    public class CosmeticSkinDefinition_007 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_007";
        [SerializeField] private string outfitName = "Adventurer Outfit #007";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (7 * 50);
        [SerializeField] private int requiredDistanceMeters = 7 * 800;
