namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #019
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_019", menuName = "RelicRun/Cosmetics/Skin #019")]
    public class CosmeticSkinDefinition_019 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_019";
        [SerializeField] private string outfitName = "Adventurer Outfit #019";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (19 * 50);
        [SerializeField] private int requiredDistanceMeters = 19 * 800;
