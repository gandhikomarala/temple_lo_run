namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #049
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_049", menuName = "RelicRun/Cosmetics/Skin #049")]
    public class CosmeticSkinDefinition_049 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_049";
        [SerializeField] private string outfitName = "Adventurer Outfit #049";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (49 * 50);
        [SerializeField] private int requiredDistanceMeters = 49 * 800;
