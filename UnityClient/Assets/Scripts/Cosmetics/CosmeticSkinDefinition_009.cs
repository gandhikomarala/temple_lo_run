namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #009
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_009", menuName = "RelicRun/Cosmetics/Skin #009")]
    public class CosmeticSkinDefinition_009 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_009";
        [SerializeField] private string outfitName = "Adventurer Outfit #009";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (9 * 50);
        [SerializeField] private int requiredDistanceMeters = 9 * 800;
