namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #097
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_097", menuName = "RelicRun/Cosmetics/Skin #097")]
    public class CosmeticSkinDefinition_097 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_097";
        [SerializeField] private string outfitName = "Adventurer Outfit #097";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (97 * 50);
        [SerializeField] private int requiredDistanceMeters = 97 * 800;
