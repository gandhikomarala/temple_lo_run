namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #109
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_109", menuName = "RelicRun/Cosmetics/Skin #109")]
    public class CosmeticSkinDefinition_109 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_109";
        [SerializeField] private string outfitName = "Adventurer Outfit #109";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (109 * 50);
        [SerializeField] private int requiredDistanceMeters = 109 * 800;
