namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #034
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_034", menuName = "RelicRun/Cosmetics/Skin #034")]
    public class CosmeticSkinDefinition_034 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_034";
        [SerializeField] private string outfitName = "Adventurer Outfit #034";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (34 * 50);
        [SerializeField] private int requiredDistanceMeters = 34 * 800;
