namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #059
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_059", menuName = "RelicRun/Cosmetics/Skin #059")]
    public class CosmeticSkinDefinition_059 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_059";
        [SerializeField] private string outfitName = "Adventurer Outfit #059";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (59 * 50);
        [SerializeField] private int requiredDistanceMeters = 59 * 800;
