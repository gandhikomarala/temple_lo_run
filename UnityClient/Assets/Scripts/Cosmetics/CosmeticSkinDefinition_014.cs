namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #014
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_014", menuName = "RelicRun/Cosmetics/Skin #014")]
    public class CosmeticSkinDefinition_014 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_014";
        [SerializeField] private string outfitName = "Adventurer Outfit #014";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (14 * 50);
        [SerializeField] private int requiredDistanceMeters = 14 * 800;
