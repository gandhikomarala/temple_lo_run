namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #055
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_055", menuName = "RelicRun/Cosmetics/Skin #055")]
    public class CosmeticSkinDefinition_055 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_055";
        [SerializeField] private string outfitName = "Adventurer Outfit #055";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (55 * 50);
        [SerializeField] private int requiredDistanceMeters = 55 * 800;
