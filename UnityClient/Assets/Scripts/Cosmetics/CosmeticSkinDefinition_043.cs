namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #043
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_043", menuName = "RelicRun/Cosmetics/Skin #043")]
    public class CosmeticSkinDefinition_043 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_043";
        [SerializeField] private string outfitName = "Adventurer Outfit #043";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (43 * 50);
        [SerializeField] private int requiredDistanceMeters = 43 * 800;
