namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #134
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_134", menuName = "RelicRun/Cosmetics/Skin #134")]
    public class CosmeticSkinDefinition_134 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_134";
        [SerializeField] private string outfitName = "Adventurer Outfit #134";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (134 * 50);
        [SerializeField] private int requiredDistanceMeters = 134 * 800;
