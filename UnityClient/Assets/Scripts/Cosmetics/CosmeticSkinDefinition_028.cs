namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #028
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_028", menuName = "RelicRun/Cosmetics/Skin #028")]
    public class CosmeticSkinDefinition_028 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_028";
        [SerializeField] private string outfitName = "Adventurer Outfit #028";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (28 * 50);
        [SerializeField] private int requiredDistanceMeters = 28 * 800;
