namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #100
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_100", menuName = "RelicRun/Cosmetics/Skin #100")]
    public class CosmeticSkinDefinition_100 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_100";
        [SerializeField] private string outfitName = "Adventurer Outfit #100";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (100 * 50);
        [SerializeField] private int requiredDistanceMeters = 100 * 800;
