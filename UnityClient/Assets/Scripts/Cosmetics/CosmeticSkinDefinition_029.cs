namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #029
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_029", menuName = "RelicRun/Cosmetics/Skin #029")]
    public class CosmeticSkinDefinition_029 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_029";
        [SerializeField] private string outfitName = "Adventurer Outfit #029";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (29 * 50);
        [SerializeField] private int requiredDistanceMeters = 29 * 800;
