namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #004
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_004", menuName = "RelicRun/Cosmetics/Skin #004")]
    public class CosmeticSkinDefinition_004 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_004";
        [SerializeField] private string outfitName = "Adventurer Outfit #004";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (4 * 50);
        [SerializeField] private int requiredDistanceMeters = 4 * 800;
