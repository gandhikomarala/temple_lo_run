namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #060
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_060", menuName = "RelicRun/Cosmetics/Skin #060")]
    public class CosmeticSkinDefinition_060 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_060";
        [SerializeField] private string outfitName = "Adventurer Outfit #060";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (60 * 50);
        [SerializeField] private int requiredDistanceMeters = 60 * 800;
