namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #081
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_081", menuName = "RelicRun/Cosmetics/Skin #081")]
    public class CosmeticSkinDefinition_081 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_081";
        [SerializeField] private string outfitName = "Adventurer Outfit #081";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (81 * 50);
        [SerializeField] private int requiredDistanceMeters = 81 * 800;
