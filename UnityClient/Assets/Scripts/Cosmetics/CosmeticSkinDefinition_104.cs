namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #104
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_104", menuName = "RelicRun/Cosmetics/Skin #104")]
    public class CosmeticSkinDefinition_104 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_104";
        [SerializeField] private string outfitName = "Adventurer Outfit #104";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (104 * 50);
        [SerializeField] private int requiredDistanceMeters = 104 * 800;
