namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #132
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_132", menuName = "RelicRun/Cosmetics/Skin #132")]
    public class CosmeticSkinDefinition_132 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_132";
        [SerializeField] private string outfitName = "Adventurer Outfit #132";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (132 * 50);
        [SerializeField] private int requiredDistanceMeters = 132 * 800;
