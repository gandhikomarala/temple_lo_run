namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #112
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_112", menuName = "RelicRun/Cosmetics/Skin #112")]
    public class CosmeticSkinDefinition_112 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_112";
        [SerializeField] private string outfitName = "Adventurer Outfit #112";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (112 * 50);
        [SerializeField] private int requiredDistanceMeters = 112 * 800;
