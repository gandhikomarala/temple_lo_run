namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #056
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_056", menuName = "RelicRun/Cosmetics/Skin #056")]
    public class CosmeticSkinDefinition_056 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_056";
        [SerializeField] private string outfitName = "Adventurer Outfit #056";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (56 * 50);
        [SerializeField] private int requiredDistanceMeters = 56 * 800;
