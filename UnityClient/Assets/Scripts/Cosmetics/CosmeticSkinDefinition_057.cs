namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #057
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_057", menuName = "RelicRun/Cosmetics/Skin #057")]
    public class CosmeticSkinDefinition_057 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_057";
        [SerializeField] private string outfitName = "Adventurer Outfit #057";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (57 * 50);
        [SerializeField] private int requiredDistanceMeters = 57 * 800;
