namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #075
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_075", menuName = "RelicRun/Cosmetics/Skin #075")]
    public class CosmeticSkinDefinition_075 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_075";
        [SerializeField] private string outfitName = "Adventurer Outfit #075";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (75 * 50);
        [SerializeField] private int requiredDistanceMeters = 75 * 800;
