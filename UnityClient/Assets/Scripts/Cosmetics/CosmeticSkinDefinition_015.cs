namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #015
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_015", menuName = "RelicRun/Cosmetics/Skin #015")]
    public class CosmeticSkinDefinition_015 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_015";
        [SerializeField] private string outfitName = "Adventurer Outfit #015";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (15 * 50);
        [SerializeField] private int requiredDistanceMeters = 15 * 800;
