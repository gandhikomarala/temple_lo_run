namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #096
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_096", menuName = "RelicRun/Cosmetics/Skin #096")]
    public class CosmeticSkinDefinition_096 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_096";
        [SerializeField] private string outfitName = "Adventurer Outfit #096";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (96 * 50);
        [SerializeField] private int requiredDistanceMeters = 96 * 800;
