namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #147
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_147", menuName = "RelicRun/Cosmetics/Skin #147")]
    public class CosmeticSkinDefinition_147 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_147";
        [SerializeField] private string outfitName = "Adventurer Outfit #147";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (147 * 50);
        [SerializeField] private int requiredDistanceMeters = 147 * 800;
