namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #092
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_092", menuName = "RelicRun/Cosmetics/Skin #092")]
    public class CosmeticSkinDefinition_092 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_092";
        [SerializeField] private string outfitName = "Adventurer Outfit #092";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (92 * 50);
        [SerializeField] private int requiredDistanceMeters = 92 * 800;
