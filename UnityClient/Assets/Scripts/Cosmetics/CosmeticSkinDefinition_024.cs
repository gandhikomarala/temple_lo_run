namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #024
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_024", menuName = "RelicRun/Cosmetics/Skin #024")]
    public class CosmeticSkinDefinition_024 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_024";
        [SerializeField] private string outfitName = "Adventurer Outfit #024";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (24 * 50);
        [SerializeField] private int requiredDistanceMeters = 24 * 800;
