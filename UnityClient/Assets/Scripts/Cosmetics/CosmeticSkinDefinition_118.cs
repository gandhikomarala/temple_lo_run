namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #118
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_118", menuName = "RelicRun/Cosmetics/Skin #118")]
    public class CosmeticSkinDefinition_118 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_118";
        [SerializeField] private string outfitName = "Adventurer Outfit #118";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (118 * 50);
        [SerializeField] private int requiredDistanceMeters = 118 * 800;
