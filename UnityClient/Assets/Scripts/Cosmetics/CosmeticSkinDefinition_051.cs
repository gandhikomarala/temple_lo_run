namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #051
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_051", menuName = "RelicRun/Cosmetics/Skin #051")]
    public class CosmeticSkinDefinition_051 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_051";
        [SerializeField] private string outfitName = "Adventurer Outfit #051";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (51 * 50);
        [SerializeField] private int requiredDistanceMeters = 51 * 800;
