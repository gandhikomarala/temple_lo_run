namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #120
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_120", menuName = "RelicRun/Cosmetics/Skin #120")]
    public class CosmeticSkinDefinition_120 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_120";
        [SerializeField] private string outfitName = "Adventurer Outfit #120";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (120 * 50);
        [SerializeField] private int requiredDistanceMeters = 120 * 800;
