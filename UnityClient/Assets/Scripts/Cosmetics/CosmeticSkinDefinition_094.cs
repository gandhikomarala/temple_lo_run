namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #094
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_094", menuName = "RelicRun/Cosmetics/Skin #094")]
    public class CosmeticSkinDefinition_094 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_094";
        [SerializeField] private string outfitName = "Adventurer Outfit #094";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (94 * 50);
        [SerializeField] private int requiredDistanceMeters = 94 * 800;
