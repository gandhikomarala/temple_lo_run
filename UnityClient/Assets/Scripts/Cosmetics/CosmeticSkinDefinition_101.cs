namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #101
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_101", menuName = "RelicRun/Cosmetics/Skin #101")]
    public class CosmeticSkinDefinition_101 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_101";
        [SerializeField] private string outfitName = "Adventurer Outfit #101";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (101 * 50);
        [SerializeField] private int requiredDistanceMeters = 101 * 800;
