namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #089
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_089", menuName = "RelicRun/Cosmetics/Skin #089")]
    public class CosmeticSkinDefinition_089 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_089";
        [SerializeField] private string outfitName = "Adventurer Outfit #089";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (89 * 50);
        [SerializeField] private int requiredDistanceMeters = 89 * 800;
