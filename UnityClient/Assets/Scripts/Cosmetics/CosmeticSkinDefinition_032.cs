namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #032
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_032", menuName = "RelicRun/Cosmetics/Skin #032")]
    public class CosmeticSkinDefinition_032 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_032";
        [SerializeField] private string outfitName = "Adventurer Outfit #032";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (32 * 50);
        [SerializeField] private int requiredDistanceMeters = 32 * 800;
