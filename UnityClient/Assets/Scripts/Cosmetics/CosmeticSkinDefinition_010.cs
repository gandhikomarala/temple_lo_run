namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #010
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_010", menuName = "RelicRun/Cosmetics/Skin #010")]
    public class CosmeticSkinDefinition_010 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_010";
        [SerializeField] private string outfitName = "Adventurer Outfit #010";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (10 * 50);
        [SerializeField] private int requiredDistanceMeters = 10 * 800;
