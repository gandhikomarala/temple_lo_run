namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #090
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_090", menuName = "RelicRun/Cosmetics/Skin #090")]
    public class CosmeticSkinDefinition_090 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_090";
        [SerializeField] private string outfitName = "Adventurer Outfit #090";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (90 * 50);
        [SerializeField] private int requiredDistanceMeters = 90 * 800;
