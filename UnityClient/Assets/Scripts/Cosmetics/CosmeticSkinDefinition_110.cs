namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #110
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_110", menuName = "RelicRun/Cosmetics/Skin #110")]
    public class CosmeticSkinDefinition_110 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_110";
        [SerializeField] private string outfitName = "Adventurer Outfit #110";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (110 * 50);
        [SerializeField] private int requiredDistanceMeters = 110 * 800;
