namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #011
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_011", menuName = "RelicRun/Cosmetics/Skin #011")]
    public class CosmeticSkinDefinition_011 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_011";
        [SerializeField] private string outfitName = "Adventurer Outfit #011";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (11 * 50);
        [SerializeField] private int requiredDistanceMeters = 11 * 800;
