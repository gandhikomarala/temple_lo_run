namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #129
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_129", menuName = "RelicRun/Cosmetics/Skin #129")]
    public class CosmeticSkinDefinition_129 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_129";
        [SerializeField] private string outfitName = "Adventurer Outfit #129";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (129 * 50);
        [SerializeField] private int requiredDistanceMeters = 129 * 800;
