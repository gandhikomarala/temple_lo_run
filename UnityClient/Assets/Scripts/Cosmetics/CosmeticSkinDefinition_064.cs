namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #064
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_064", menuName = "RelicRun/Cosmetics/Skin #064")]
    public class CosmeticSkinDefinition_064 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_064";
        [SerializeField] private string outfitName = "Adventurer Outfit #064";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (64 * 50);
        [SerializeField] private int requiredDistanceMeters = 64 * 800;
