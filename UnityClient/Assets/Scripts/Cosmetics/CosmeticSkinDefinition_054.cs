namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #054
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_054", menuName = "RelicRun/Cosmetics/Skin #054")]
    public class CosmeticSkinDefinition_054 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_054";
        [SerializeField] private string outfitName = "Adventurer Outfit #054";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (54 * 50);
        [SerializeField] private int requiredDistanceMeters = 54 * 800;
