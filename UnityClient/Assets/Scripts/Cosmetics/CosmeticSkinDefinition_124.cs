namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #124
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_124", menuName = "RelicRun/Cosmetics/Skin #124")]
    public class CosmeticSkinDefinition_124 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_124";
        [SerializeField] private string outfitName = "Adventurer Outfit #124";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (124 * 50);
        [SerializeField] private int requiredDistanceMeters = 124 * 800;
