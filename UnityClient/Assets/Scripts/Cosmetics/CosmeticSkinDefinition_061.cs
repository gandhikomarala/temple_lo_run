namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #061
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_061", menuName = "RelicRun/Cosmetics/Skin #061")]
    public class CosmeticSkinDefinition_061 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_061";
        [SerializeField] private string outfitName = "Adventurer Outfit #061";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (61 * 50);
        [SerializeField] private int requiredDistanceMeters = 61 * 800;
