namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #093
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_093", menuName = "RelicRun/Cosmetics/Skin #093")]
    public class CosmeticSkinDefinition_093 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_093";
        [SerializeField] private string outfitName = "Adventurer Outfit #093";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (93 * 50);
        [SerializeField] private int requiredDistanceMeters = 93 * 800;
