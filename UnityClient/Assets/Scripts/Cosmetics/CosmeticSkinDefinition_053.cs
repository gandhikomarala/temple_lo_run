namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #053
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_053", menuName = "RelicRun/Cosmetics/Skin #053")]
    public class CosmeticSkinDefinition_053 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_053";
        [SerializeField] private string outfitName = "Adventurer Outfit #053";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (53 * 50);
        [SerializeField] private int requiredDistanceMeters = 53 * 800;
