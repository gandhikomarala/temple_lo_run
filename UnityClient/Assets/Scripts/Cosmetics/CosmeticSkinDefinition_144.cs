namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #144
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_144", menuName = "RelicRun/Cosmetics/Skin #144")]
    public class CosmeticSkinDefinition_144 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_144";
        [SerializeField] private string outfitName = "Adventurer Outfit #144";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (144 * 50);
        [SerializeField] private int requiredDistanceMeters = 144 * 800;
