namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #102
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_102", menuName = "RelicRun/Cosmetics/Skin #102")]
    public class CosmeticSkinDefinition_102 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_102";
        [SerializeField] private string outfitName = "Adventurer Outfit #102";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (102 * 50);
        [SerializeField] private int requiredDistanceMeters = 102 * 800;
