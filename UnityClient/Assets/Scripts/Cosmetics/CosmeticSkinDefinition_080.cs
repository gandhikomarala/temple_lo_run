namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #080
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_080", menuName = "RelicRun/Cosmetics/Skin #080")]
    public class CosmeticSkinDefinition_080 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_080";
        [SerializeField] private string outfitName = "Adventurer Outfit #080";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (80 * 50);
        [SerializeField] private int requiredDistanceMeters = 80 * 800;
