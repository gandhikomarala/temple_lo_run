namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #027
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_027", menuName = "RelicRun/Cosmetics/Skin #027")]
    public class CosmeticSkinDefinition_027 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_027";
        [SerializeField] private string outfitName = "Adventurer Outfit #027";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (27 * 50);
        [SerializeField] private int requiredDistanceMeters = 27 * 800;
