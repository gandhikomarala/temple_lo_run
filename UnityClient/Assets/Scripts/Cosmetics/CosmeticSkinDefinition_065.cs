namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #065
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_065", menuName = "RelicRun/Cosmetics/Skin #065")]
    public class CosmeticSkinDefinition_065 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_065";
        [SerializeField] private string outfitName = "Adventurer Outfit #065";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (65 * 50);
        [SerializeField] private int requiredDistanceMeters = 65 * 800;
