namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #130
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_130", menuName = "RelicRun/Cosmetics/Skin #130")]
    public class CosmeticSkinDefinition_130 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_130";
        [SerializeField] private string outfitName = "Adventurer Outfit #130";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (130 * 50);
        [SerializeField] private int requiredDistanceMeters = 130 * 800;
