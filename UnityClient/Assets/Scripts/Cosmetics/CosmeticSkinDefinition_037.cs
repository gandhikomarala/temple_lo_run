namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #037
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_037", menuName = "RelicRun/Cosmetics/Skin #037")]
    public class CosmeticSkinDefinition_037 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_037";
        [SerializeField] private string outfitName = "Adventurer Outfit #037";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (37 * 50);
        [SerializeField] private int requiredDistanceMeters = 37 * 800;
