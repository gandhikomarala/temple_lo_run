namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #111
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_111", menuName = "RelicRun/Cosmetics/Skin #111")]
    public class CosmeticSkinDefinition_111 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_111";
        [SerializeField] private string outfitName = "Adventurer Outfit #111";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (111 * 50);
        [SerializeField] private int requiredDistanceMeters = 111 * 800;
