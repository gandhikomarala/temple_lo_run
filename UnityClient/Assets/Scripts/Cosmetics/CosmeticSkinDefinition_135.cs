namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #135
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_135", menuName = "RelicRun/Cosmetics/Skin #135")]
    public class CosmeticSkinDefinition_135 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_135";
        [SerializeField] private string outfitName = "Adventurer Outfit #135";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (135 * 50);
        [SerializeField] private int requiredDistanceMeters = 135 * 800;
