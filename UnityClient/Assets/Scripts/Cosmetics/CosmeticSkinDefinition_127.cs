namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #127
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_127", menuName = "RelicRun/Cosmetics/Skin #127")]
    public class CosmeticSkinDefinition_127 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_127";
        [SerializeField] private string outfitName = "Adventurer Outfit #127";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (127 * 50);
        [SerializeField] private int requiredDistanceMeters = 127 * 800;
