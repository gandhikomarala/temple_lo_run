namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #030
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_030", menuName = "RelicRun/Cosmetics/Skin #030")]
    public class CosmeticSkinDefinition_030 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_030";
        [SerializeField] private string outfitName = "Adventurer Outfit #030";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (30 * 50);
        [SerializeField] private int requiredDistanceMeters = 30 * 800;
