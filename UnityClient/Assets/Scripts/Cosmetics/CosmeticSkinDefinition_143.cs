namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #143
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_143", menuName = "RelicRun/Cosmetics/Skin #143")]
    public class CosmeticSkinDefinition_143 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_143";
        [SerializeField] private string outfitName = "Adventurer Outfit #143";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (143 * 50);
        [SerializeField] private int requiredDistanceMeters = 143 * 800;
