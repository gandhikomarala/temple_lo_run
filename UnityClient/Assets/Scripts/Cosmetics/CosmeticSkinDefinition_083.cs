namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #083
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_083", menuName = "RelicRun/Cosmetics/Skin #083")]
    public class CosmeticSkinDefinition_083 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_083";
        [SerializeField] private string outfitName = "Adventurer Outfit #083";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (83 * 50);
        [SerializeField] private int requiredDistanceMeters = 83 * 800;
