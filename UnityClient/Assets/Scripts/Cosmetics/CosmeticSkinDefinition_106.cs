namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #106
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_106", menuName = "RelicRun/Cosmetics/Skin #106")]
    public class CosmeticSkinDefinition_106 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_106";
        [SerializeField] private string outfitName = "Adventurer Outfit #106";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (106 * 50);
        [SerializeField] private int requiredDistanceMeters = 106 * 800;
