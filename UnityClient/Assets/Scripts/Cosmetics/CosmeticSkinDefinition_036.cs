namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #036
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_036", menuName = "RelicRun/Cosmetics/Skin #036")]
    public class CosmeticSkinDefinition_036 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_036";
        [SerializeField] private string outfitName = "Adventurer Outfit #036";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (36 * 50);
        [SerializeField] private int requiredDistanceMeters = 36 * 800;
