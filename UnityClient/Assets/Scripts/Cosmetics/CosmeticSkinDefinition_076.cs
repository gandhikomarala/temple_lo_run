namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #076
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_076", menuName = "RelicRun/Cosmetics/Skin #076")]
    public class CosmeticSkinDefinition_076 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_076";
        [SerializeField] private string outfitName = "Adventurer Outfit #076";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (76 * 50);
        [SerializeField] private int requiredDistanceMeters = 76 * 800;
