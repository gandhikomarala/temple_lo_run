namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #113
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_113", menuName = "RelicRun/Cosmetics/Skin #113")]
    public class CosmeticSkinDefinition_113 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_113";
        [SerializeField] private string outfitName = "Adventurer Outfit #113";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (113 * 50);
        [SerializeField] private int requiredDistanceMeters = 113 * 800;
