namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #002
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_002", menuName = "RelicRun/Cosmetics/Skin #002")]
    public class CosmeticSkinDefinition_002 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_002";
        [SerializeField] private string outfitName = "Adventurer Outfit #002";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (2 * 50);
        [SerializeField] private int requiredDistanceMeters = 2 * 800;
