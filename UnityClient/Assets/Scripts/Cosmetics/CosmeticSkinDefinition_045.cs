namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #045
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_045", menuName = "RelicRun/Cosmetics/Skin #045")]
    public class CosmeticSkinDefinition_045 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_045";
        [SerializeField] private string outfitName = "Adventurer Outfit #045";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (45 * 50);
        [SerializeField] private int requiredDistanceMeters = 45 * 800;
