namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #078
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_078", menuName = "RelicRun/Cosmetics/Skin #078")]
    public class CosmeticSkinDefinition_078 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_078";
        [SerializeField] private string outfitName = "Adventurer Outfit #078";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (78 * 50);
        [SerializeField] private int requiredDistanceMeters = 78 * 800;
