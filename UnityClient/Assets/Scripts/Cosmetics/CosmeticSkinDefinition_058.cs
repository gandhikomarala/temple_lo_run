namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #058
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_058", menuName = "RelicRun/Cosmetics/Skin #058")]
    public class CosmeticSkinDefinition_058 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_058";
        [SerializeField] private string outfitName = "Adventurer Outfit #058";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (58 * 50);
        [SerializeField] private int requiredDistanceMeters = 58 * 800;
