namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #149
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_149", menuName = "RelicRun/Cosmetics/Skin #149")]
    public class CosmeticSkinDefinition_149 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_149";
        [SerializeField] private string outfitName = "Adventurer Outfit #149";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (149 * 50);
        [SerializeField] private int requiredDistanceMeters = 149 * 800;
