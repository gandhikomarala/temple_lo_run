namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #074
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_074", menuName = "RelicRun/Cosmetics/Skin #074")]
    public class CosmeticSkinDefinition_074 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_074";
        [SerializeField] private string outfitName = "Adventurer Outfit #074";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (74 * 50);
        [SerializeField] private int requiredDistanceMeters = 74 * 800;
