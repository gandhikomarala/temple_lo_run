namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #035
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_035", menuName = "RelicRun/Cosmetics/Skin #035")]
    public class CosmeticSkinDefinition_035 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_035";
        [SerializeField] private string outfitName = "Adventurer Outfit #035";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (35 * 50);
        [SerializeField] private int requiredDistanceMeters = 35 * 800;
