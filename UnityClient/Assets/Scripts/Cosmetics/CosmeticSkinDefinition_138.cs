namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #138
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_138", menuName = "RelicRun/Cosmetics/Skin #138")]
    public class CosmeticSkinDefinition_138 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_138";
        [SerializeField] private string outfitName = "Adventurer Outfit #138";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (138 * 50);
        [SerializeField] private int requiredDistanceMeters = 138 * 800;
