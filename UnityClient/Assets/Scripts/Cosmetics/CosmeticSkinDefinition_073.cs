namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #073
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_073", menuName = "RelicRun/Cosmetics/Skin #073")]
    public class CosmeticSkinDefinition_073 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_073";
        [SerializeField] private string outfitName = "Adventurer Outfit #073";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (73 * 50);
        [SerializeField] private int requiredDistanceMeters = 73 * 800;
