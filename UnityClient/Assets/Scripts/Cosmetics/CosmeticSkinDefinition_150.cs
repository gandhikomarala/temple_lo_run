namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #150
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_150", menuName = "RelicRun/Cosmetics/Skin #150")]
    public class CosmeticSkinDefinition_150 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_150";
        [SerializeField] private string outfitName = "Adventurer Outfit #150";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (150 * 50);
        [SerializeField] private int requiredDistanceMeters = 150 * 800;
