namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #063
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_063", menuName = "RelicRun/Cosmetics/Skin #063")]
    public class CosmeticSkinDefinition_063 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_063";
        [SerializeField] private string outfitName = "Adventurer Outfit #063";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (63 * 50);
        [SerializeField] private int requiredDistanceMeters = 63 * 800;
