namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #048
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_048", menuName = "RelicRun/Cosmetics/Skin #048")]
    public class CosmeticSkinDefinition_048 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_048";
        [SerializeField] private string outfitName = "Adventurer Outfit #048";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (48 * 50);
        [SerializeField] private int requiredDistanceMeters = 48 * 800;
