namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #031
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_031", menuName = "RelicRun/Cosmetics/Skin #031")]
    public class CosmeticSkinDefinition_031 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_031";
        [SerializeField] private string outfitName = "Adventurer Outfit #031";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (31 * 50);
        [SerializeField] private int requiredDistanceMeters = 31 * 800;
