namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #008
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_008", menuName = "RelicRun/Cosmetics/Skin #008")]
    public class CosmeticSkinDefinition_008 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_008";
        [SerializeField] private string outfitName = "Adventurer Outfit #008";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (8 * 50);
        [SerializeField] private int requiredDistanceMeters = 8 * 800;
