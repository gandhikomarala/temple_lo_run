namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #047
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_047", menuName = "RelicRun/Cosmetics/Skin #047")]
    public class CosmeticSkinDefinition_047 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_047";
        [SerializeField] private string outfitName = "Adventurer Outfit #047";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (47 * 50);
        [SerializeField] private int requiredDistanceMeters = 47 * 800;
