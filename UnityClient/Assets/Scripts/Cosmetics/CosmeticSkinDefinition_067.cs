namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #067
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_067", menuName = "RelicRun/Cosmetics/Skin #067")]
    public class CosmeticSkinDefinition_067 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_067";
        [SerializeField] private string outfitName = "Adventurer Outfit #067";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (67 * 50);
        [SerializeField] private int requiredDistanceMeters = 67 * 800;
