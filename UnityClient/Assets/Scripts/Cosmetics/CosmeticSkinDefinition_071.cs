namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #071
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_071", menuName = "RelicRun/Cosmetics/Skin #071")]
    public class CosmeticSkinDefinition_071 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_071";
        [SerializeField] private string outfitName = "Adventurer Outfit #071";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (71 * 50);
        [SerializeField] private int requiredDistanceMeters = 71 * 800;
