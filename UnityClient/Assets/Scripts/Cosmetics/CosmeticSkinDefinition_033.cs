namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #033
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_033", menuName = "RelicRun/Cosmetics/Skin #033")]
    public class CosmeticSkinDefinition_033 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_033";
        [SerializeField] private string outfitName = "Adventurer Outfit #033";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (33 * 50);
        [SerializeField] private int requiredDistanceMeters = 33 * 800;
