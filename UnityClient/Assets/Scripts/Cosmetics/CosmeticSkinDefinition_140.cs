namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #140
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_140", menuName = "RelicRun/Cosmetics/Skin #140")]
    public class CosmeticSkinDefinition_140 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_140";
        [SerializeField] private string outfitName = "Adventurer Outfit #140";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (140 * 50);
        [SerializeField] private int requiredDistanceMeters = 140 * 800;
