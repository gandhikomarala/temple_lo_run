namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #042
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_042", menuName = "RelicRun/Cosmetics/Skin #042")]
    public class CosmeticSkinDefinition_042 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_042";
        [SerializeField] private string outfitName = "Adventurer Outfit #042";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (42 * 50);
        [SerializeField] private int requiredDistanceMeters = 42 * 800;
