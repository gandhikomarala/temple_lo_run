namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #137
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_137", menuName = "RelicRun/Cosmetics/Skin #137")]
    public class CosmeticSkinDefinition_137 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_137";
        [SerializeField] private string outfitName = "Adventurer Outfit #137";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (137 * 50);
        [SerializeField] private int requiredDistanceMeters = 137 * 800;
