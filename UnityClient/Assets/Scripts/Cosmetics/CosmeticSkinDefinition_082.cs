namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #082
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_082", menuName = "RelicRun/Cosmetics/Skin #082")]
    public class CosmeticSkinDefinition_082 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_082";
        [SerializeField] private string outfitName = "Adventurer Outfit #082";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (82 * 50);
        [SerializeField] private int requiredDistanceMeters = 82 * 800;
