namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #050
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_050", menuName = "RelicRun/Cosmetics/Skin #050")]
    public class CosmeticSkinDefinition_050 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_050";
        [SerializeField] private string outfitName = "Adventurer Outfit #050";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (50 * 50);
        [SerializeField] private int requiredDistanceMeters = 50 * 800;
