namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #041
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_041", menuName = "RelicRun/Cosmetics/Skin #041")]
    public class CosmeticSkinDefinition_041 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_041";
        [SerializeField] private string outfitName = "Adventurer Outfit #041";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (41 * 50);
        [SerializeField] private int requiredDistanceMeters = 41 * 800;
