namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #107
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_107", menuName = "RelicRun/Cosmetics/Skin #107")]
    public class CosmeticSkinDefinition_107 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_107";
        [SerializeField] private string outfitName = "Adventurer Outfit #107";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (107 * 50);
        [SerializeField] private int requiredDistanceMeters = 107 * 800;
