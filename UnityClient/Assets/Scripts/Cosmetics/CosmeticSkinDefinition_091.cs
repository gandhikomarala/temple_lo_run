namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #091
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_091", menuName = "RelicRun/Cosmetics/Skin #091")]
    public class CosmeticSkinDefinition_091 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_091";
        [SerializeField] private string outfitName = "Adventurer Outfit #091";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (91 * 50);
        [SerializeField] private int requiredDistanceMeters = 91 * 800;
