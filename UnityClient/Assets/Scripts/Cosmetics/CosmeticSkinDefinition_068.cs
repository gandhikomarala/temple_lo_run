namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #068
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_068", menuName = "RelicRun/Cosmetics/Skin #068")]
    public class CosmeticSkinDefinition_068 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_068";
        [SerializeField] private string outfitName = "Adventurer Outfit #068";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (68 * 50);
        [SerializeField] private int requiredDistanceMeters = 68 * 800;
