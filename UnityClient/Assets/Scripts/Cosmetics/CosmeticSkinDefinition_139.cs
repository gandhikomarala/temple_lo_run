namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #139
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_139", menuName = "RelicRun/Cosmetics/Skin #139")]
    public class CosmeticSkinDefinition_139 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_139";
        [SerializeField] private string outfitName = "Adventurer Outfit #139";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (139 * 50);
        [SerializeField] private int requiredDistanceMeters = 139 * 800;
