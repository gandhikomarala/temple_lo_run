namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #085
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_085", menuName = "RelicRun/Cosmetics/Skin #085")]
    public class CosmeticSkinDefinition_085 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_085";
        [SerializeField] private string outfitName = "Adventurer Outfit #085";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (85 * 50);
        [SerializeField] private int requiredDistanceMeters = 85 * 800;
