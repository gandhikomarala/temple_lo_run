namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #114
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_114", menuName = "RelicRun/Cosmetics/Skin #114")]
    public class CosmeticSkinDefinition_114 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_114";
        [SerializeField] private string outfitName = "Adventurer Outfit #114";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (114 * 50);
        [SerializeField] private int requiredDistanceMeters = 114 * 800;
