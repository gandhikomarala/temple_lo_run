namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #003
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_003", menuName = "RelicRun/Cosmetics/Skin #003")]
    public class CosmeticSkinDefinition_003 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_003";
        [SerializeField] private string outfitName = "Adventurer Outfit #003";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (3 * 50);
        [SerializeField] private int requiredDistanceMeters = 3 * 800;
