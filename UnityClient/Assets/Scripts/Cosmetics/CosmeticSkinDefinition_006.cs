namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #006
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_006", menuName = "RelicRun/Cosmetics/Skin #006")]
    public class CosmeticSkinDefinition_006 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_006";
        [SerializeField] private string outfitName = "Adventurer Outfit #006";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (6 * 50);
        [SerializeField] private int requiredDistanceMeters = 6 * 800;
