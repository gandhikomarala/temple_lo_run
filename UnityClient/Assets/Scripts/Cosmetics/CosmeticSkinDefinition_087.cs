namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #087
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_087", menuName = "RelicRun/Cosmetics/Skin #087")]
    public class CosmeticSkinDefinition_087 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_087";
        [SerializeField] private string outfitName = "Adventurer Outfit #087";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (87 * 50);
        [SerializeField] private int requiredDistanceMeters = 87 * 800;
