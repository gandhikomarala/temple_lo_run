namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #044
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_044", menuName = "RelicRun/Cosmetics/Skin #044")]
    public class CosmeticSkinDefinition_044 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_044";
        [SerializeField] private string outfitName = "Adventurer Outfit #044";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (44 * 50);
        [SerializeField] private int requiredDistanceMeters = 44 * 800;
