namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #119
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_119", menuName = "RelicRun/Cosmetics/Skin #119")]
    public class CosmeticSkinDefinition_119 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_119";
        [SerializeField] private string outfitName = "Adventurer Outfit #119";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (119 * 50);
        [SerializeField] private int requiredDistanceMeters = 119 * 800;
