namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #116
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_116", menuName = "RelicRun/Cosmetics/Skin #116")]
    public class CosmeticSkinDefinition_116 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_116";
        [SerializeField] private string outfitName = "Adventurer Outfit #116";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (116 * 50);
        [SerializeField] private int requiredDistanceMeters = 116 * 800;
