namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #117
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_117", menuName = "RelicRun/Cosmetics/Skin #117")]
    public class CosmeticSkinDefinition_117 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_117";
        [SerializeField] private string outfitName = "Adventurer Outfit #117";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (117 * 50);
        [SerializeField] private int requiredDistanceMeters = 117 * 800;
