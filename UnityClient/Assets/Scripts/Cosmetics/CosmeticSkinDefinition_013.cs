namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #013
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_013", menuName = "RelicRun/Cosmetics/Skin #013")]
    public class CosmeticSkinDefinition_013 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_013";
        [SerializeField] private string outfitName = "Adventurer Outfit #013";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (13 * 50);
        [SerializeField] private int requiredDistanceMeters = 13 * 800;
