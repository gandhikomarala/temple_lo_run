namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #128
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_128", menuName = "RelicRun/Cosmetics/Skin #128")]
    public class CosmeticSkinDefinition_128 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_128";
        [SerializeField] private string outfitName = "Adventurer Outfit #128";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (128 * 50);
        [SerializeField] private int requiredDistanceMeters = 128 * 800;
