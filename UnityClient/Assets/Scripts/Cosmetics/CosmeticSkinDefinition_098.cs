namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #098
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_098", menuName = "RelicRun/Cosmetics/Skin #098")]
    public class CosmeticSkinDefinition_098 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_098";
        [SerializeField] private string outfitName = "Adventurer Outfit #098";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (98 * 50);
        [SerializeField] private int requiredDistanceMeters = 98 * 800;
