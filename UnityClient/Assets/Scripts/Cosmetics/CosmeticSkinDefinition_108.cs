namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #108
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_108", menuName = "RelicRun/Cosmetics/Skin #108")]
    public class CosmeticSkinDefinition_108 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_108";
        [SerializeField] private string outfitName = "Adventurer Outfit #108";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (108 * 50);
        [SerializeField] private int requiredDistanceMeters = 108 * 800;
