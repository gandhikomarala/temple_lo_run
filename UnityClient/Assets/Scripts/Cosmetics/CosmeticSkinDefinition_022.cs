namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #022
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_022", menuName = "RelicRun/Cosmetics/Skin #022")]
    public class CosmeticSkinDefinition_022 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_022";
        [SerializeField] private string outfitName = "Adventurer Outfit #022";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (22 * 50);
        [SerializeField] private int requiredDistanceMeters = 22 * 800;
