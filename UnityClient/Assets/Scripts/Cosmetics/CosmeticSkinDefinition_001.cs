namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #001
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_001", menuName = "RelicRun/Cosmetics/Skin #001")]
    public class CosmeticSkinDefinition_001 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_001";
        [SerializeField] private string outfitName = "Adventurer Outfit #001";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (1 * 50);
        [SerializeField] private int requiredDistanceMeters = 1 * 800;
