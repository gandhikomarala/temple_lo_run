namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #146
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_146", menuName = "RelicRun/Cosmetics/Skin #146")]
    public class CosmeticSkinDefinition_146 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_146";
        [SerializeField] private string outfitName = "Adventurer Outfit #146";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (146 * 50);
        [SerializeField] private int requiredDistanceMeters = 146 * 800;
