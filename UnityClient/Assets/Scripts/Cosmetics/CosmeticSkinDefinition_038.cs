namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #038
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_038", menuName = "RelicRun/Cosmetics/Skin #038")]
    public class CosmeticSkinDefinition_038 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_038";
        [SerializeField] private string outfitName = "Adventurer Outfit #038";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (38 * 50);
        [SerializeField] private int requiredDistanceMeters = 38 * 800;
