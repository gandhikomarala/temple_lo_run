namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #016
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_016", menuName = "RelicRun/Cosmetics/Skin #016")]
    public class CosmeticSkinDefinition_016 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_016";
        [SerializeField] private string outfitName = "Adventurer Outfit #016";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (16 * 50);
        [SerializeField] private int requiredDistanceMeters = 16 * 800;
