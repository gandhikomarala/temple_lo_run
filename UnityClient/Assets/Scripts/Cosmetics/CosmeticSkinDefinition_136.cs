namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #136
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_136", menuName = "RelicRun/Cosmetics/Skin #136")]
    public class CosmeticSkinDefinition_136 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_136";
        [SerializeField] private string outfitName = "Adventurer Outfit #136";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (136 * 50);
        [SerializeField] private int requiredDistanceMeters = 136 * 800;
