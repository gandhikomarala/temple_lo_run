namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #099
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_099", menuName = "RelicRun/Cosmetics/Skin #099")]
    public class CosmeticSkinDefinition_099 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_099";
        [SerializeField] private string outfitName = "Adventurer Outfit #099";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (99 * 50);
        [SerializeField] private int requiredDistanceMeters = 99 * 800;
