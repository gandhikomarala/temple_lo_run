namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #026
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_026", menuName = "RelicRun/Cosmetics/Skin #026")]
    public class CosmeticSkinDefinition_026 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_026";
        [SerializeField] private string outfitName = "Adventurer Outfit #026";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (26 * 50);
        [SerializeField] private int requiredDistanceMeters = 26 * 800;
