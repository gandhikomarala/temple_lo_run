namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #125
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_125", menuName = "RelicRun/Cosmetics/Skin #125")]
    public class CosmeticSkinDefinition_125 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_125";
        [SerializeField] private string outfitName = "Adventurer Outfit #125";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (125 * 50);
        [SerializeField] private int requiredDistanceMeters = 125 * 800;
