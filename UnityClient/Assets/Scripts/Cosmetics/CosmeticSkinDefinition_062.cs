namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #062
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_062", menuName = "RelicRun/Cosmetics/Skin #062")]
    public class CosmeticSkinDefinition_062 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_062";
        [SerializeField] private string outfitName = "Adventurer Outfit #062";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (62 * 50);
        [SerializeField] private int requiredDistanceMeters = 62 * 800;
