namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #103
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_103", menuName = "RelicRun/Cosmetics/Skin #103")]
    public class CosmeticSkinDefinition_103 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_103";
        [SerializeField] private string outfitName = "Adventurer Outfit #103";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (103 * 50);
        [SerializeField] private int requiredDistanceMeters = 103 * 800;
