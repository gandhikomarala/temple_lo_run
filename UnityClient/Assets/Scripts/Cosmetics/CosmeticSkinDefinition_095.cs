namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #095
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_095", menuName = "RelicRun/Cosmetics/Skin #095")]
    public class CosmeticSkinDefinition_095 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_095";
        [SerializeField] private string outfitName = "Adventurer Outfit #095";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (95 * 50);
        [SerializeField] private int requiredDistanceMeters = 95 * 800;
