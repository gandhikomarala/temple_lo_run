namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #148
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_148", menuName = "RelicRun/Cosmetics/Skin #148")]
    public class CosmeticSkinDefinition_148 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_148";
        [SerializeField] private string outfitName = "Adventurer Outfit #148";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (148 * 50);
        [SerializeField] private int requiredDistanceMeters = 148 * 800;
