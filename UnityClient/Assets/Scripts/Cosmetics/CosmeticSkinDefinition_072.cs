namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #072
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_072", menuName = "RelicRun/Cosmetics/Skin #072")]
    public class CosmeticSkinDefinition_072 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_072";
        [SerializeField] private string outfitName = "Adventurer Outfit #072";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (72 * 50);
        [SerializeField] private int requiredDistanceMeters = 72 * 800;
