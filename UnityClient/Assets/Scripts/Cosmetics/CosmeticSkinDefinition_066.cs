namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #066
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_066", menuName = "RelicRun/Cosmetics/Skin #066")]
    public class CosmeticSkinDefinition_066 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_066";
        [SerializeField] private string outfitName = "Adventurer Outfit #066";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (66 * 50);
        [SerializeField] private int requiredDistanceMeters = 66 * 800;
