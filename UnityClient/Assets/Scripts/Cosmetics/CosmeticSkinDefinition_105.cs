namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #105
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_105", menuName = "RelicRun/Cosmetics/Skin #105")]
    public class CosmeticSkinDefinition_105 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_105";
        [SerializeField] private string outfitName = "Adventurer Outfit #105";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (105 * 50);
        [SerializeField] private int requiredDistanceMeters = 105 * 800;
