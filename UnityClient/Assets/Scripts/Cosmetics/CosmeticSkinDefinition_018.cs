namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #018
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_018", menuName = "RelicRun/Cosmetics/Skin #018")]
    public class CosmeticSkinDefinition_018 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_018";
        [SerializeField] private string outfitName = "Adventurer Outfit #018";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (18 * 50);
        [SerializeField] private int requiredDistanceMeters = 18 * 800;
