namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #040
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_040", menuName = "RelicRun/Cosmetics/Skin #040")]
    public class CosmeticSkinDefinition_040 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_040";
        [SerializeField] private string outfitName = "Adventurer Outfit #040";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (40 * 50);
        [SerializeField] private int requiredDistanceMeters = 40 * 800;
