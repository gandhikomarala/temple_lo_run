namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #077
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_077", menuName = "RelicRun/Cosmetics/Skin #077")]
    public class CosmeticSkinDefinition_077 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_077";
        [SerializeField] private string outfitName = "Adventurer Outfit #077";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (77 * 50);
        [SerializeField] private int requiredDistanceMeters = 77 * 800;
