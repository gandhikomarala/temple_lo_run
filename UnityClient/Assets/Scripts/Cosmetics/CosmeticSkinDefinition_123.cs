namespace RelicRun.Cosmetics
{
    ...
    /// <summary>
    /// Cosmetic Skin & Character Wardrobe Definition #123
    /// Handles custom character outfits, particle trail effects, and unlock requirements.
    /// </summary>
    [CreateAssetMenu(fileName = "CosmeticSkinDefinition_123", menuName = "RelicRun/Cosmetics/Skin #123")]
    public class CosmeticSkinDefinition_123 : ScriptableObject
    {
        public enum RarityTier { Common, Rare, Epic, Legendary, Mythic }

        [Header("Skin Identity")]
        [SerializeField] private string skinId = "SKIN_123";
        [SerializeField] private string outfitName = "Adventurer Outfit #123";
        ...
        [SerializeField] private int requiredRelicCoins = 500 + (123 * 50);
        [SerializeField] private int requiredDistanceMeters = 123 * 800;
