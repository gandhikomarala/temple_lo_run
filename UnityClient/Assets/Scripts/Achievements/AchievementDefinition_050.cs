namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #050
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_050", menuName = "RelicRun/Achievements/Achievement #050")]
    public class AchievementDefinition_050 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_050";
        [SerializeField] private string badgeName = "Relic Hunter Tier #050";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 50 * 1000;
        [SerializeField] private int prestigePoints = 50 * 10;
