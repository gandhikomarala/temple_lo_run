namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #090
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_090", menuName = "RelicRun/Achievements/Achievement #090")]
    public class AchievementDefinition_090 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_090";
        [SerializeField] private string badgeName = "Relic Hunter Tier #090";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 90 * 1000;
        [SerializeField] private int prestigePoints = 90 * 10;
