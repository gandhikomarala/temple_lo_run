namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #024
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_024", menuName = "RelicRun/Achievements/Achievement #024")]
    public class AchievementDefinition_024 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_024";
        [SerializeField] private string badgeName = "Relic Hunter Tier #024";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 24 * 1000;
        [SerializeField] private int prestigePoints = 24 * 10;
