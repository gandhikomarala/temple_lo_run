namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #098
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_098", menuName = "RelicRun/Achievements/Achievement #098")]
    public class AchievementDefinition_098 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_098";
        [SerializeField] private string badgeName = "Relic Hunter Tier #098";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 98 * 1000;
        [SerializeField] private int prestigePoints = 98 * 10;
