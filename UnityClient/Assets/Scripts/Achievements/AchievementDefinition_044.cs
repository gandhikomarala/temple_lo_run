namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #044
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_044", menuName = "RelicRun/Achievements/Achievement #044")]
    public class AchievementDefinition_044 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_044";
        [SerializeField] private string badgeName = "Relic Hunter Tier #044";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 44 * 1000;
        [SerializeField] private int prestigePoints = 44 * 10;
