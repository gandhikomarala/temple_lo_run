namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #008
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_008", menuName = "RelicRun/Achievements/Achievement #008")]
    public class AchievementDefinition_008 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_008";
        [SerializeField] private string badgeName = "Relic Hunter Tier #008";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 8 * 1000;
        [SerializeField] private int prestigePoints = 8 * 10;
