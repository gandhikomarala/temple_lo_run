namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #046
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_046", menuName = "RelicRun/Achievements/Achievement #046")]
    public class AchievementDefinition_046 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_046";
        [SerializeField] private string badgeName = "Relic Hunter Tier #046";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 46 * 1000;
        [SerializeField] private int prestigePoints = 46 * 10;
