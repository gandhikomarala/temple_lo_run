namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #007
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_007", menuName = "RelicRun/Achievements/Achievement #007")]
    public class AchievementDefinition_007 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_007";
        [SerializeField] private string badgeName = "Relic Hunter Tier #007";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 7 * 1000;
        [SerializeField] private int prestigePoints = 7 * 10;
