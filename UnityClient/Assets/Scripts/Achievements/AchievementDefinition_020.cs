namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #020
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_020", menuName = "RelicRun/Achievements/Achievement #020")]
    public class AchievementDefinition_020 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_020";
        [SerializeField] private string badgeName = "Relic Hunter Tier #020";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 20 * 1000;
        [SerializeField] private int prestigePoints = 20 * 10;
