namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #039
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_039", menuName = "RelicRun/Achievements/Achievement #039")]
    public class AchievementDefinition_039 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_039";
        [SerializeField] private string badgeName = "Relic Hunter Tier #039";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 39 * 1000;
        [SerializeField] private int prestigePoints = 39 * 10;
