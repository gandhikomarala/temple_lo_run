namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #035
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_035", menuName = "RelicRun/Achievements/Achievement #035")]
    public class AchievementDefinition_035 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_035";
        [SerializeField] private string badgeName = "Relic Hunter Tier #035";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 35 * 1000;
        [SerializeField] private int prestigePoints = 35 * 10;
