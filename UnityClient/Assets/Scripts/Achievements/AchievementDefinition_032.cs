namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #032
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_032", menuName = "RelicRun/Achievements/Achievement #032")]
    public class AchievementDefinition_032 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_032";
        [SerializeField] private string badgeName = "Relic Hunter Tier #032";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 32 * 1000;
        [SerializeField] private int prestigePoints = 32 * 10;
