namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #042
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_042", menuName = "RelicRun/Achievements/Achievement #042")]
    public class AchievementDefinition_042 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_042";
        [SerializeField] private string badgeName = "Relic Hunter Tier #042";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 42 * 1000;
        [SerializeField] private int prestigePoints = 42 * 10;
