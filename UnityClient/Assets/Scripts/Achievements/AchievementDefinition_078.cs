namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #078
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_078", menuName = "RelicRun/Achievements/Achievement #078")]
    public class AchievementDefinition_078 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_078";
        [SerializeField] private string badgeName = "Relic Hunter Tier #078";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 78 * 1000;
        [SerializeField] private int prestigePoints = 78 * 10;
