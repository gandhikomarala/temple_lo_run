namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #040
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_040", menuName = "RelicRun/Achievements/Achievement #040")]
    public class AchievementDefinition_040 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_040";
        [SerializeField] private string badgeName = "Relic Hunter Tier #040";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 40 * 1000;
        [SerializeField] private int prestigePoints = 40 * 10;
