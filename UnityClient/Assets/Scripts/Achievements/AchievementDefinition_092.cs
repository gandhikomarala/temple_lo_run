namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #092
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_092", menuName = "RelicRun/Achievements/Achievement #092")]
    public class AchievementDefinition_092 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_092";
        [SerializeField] private string badgeName = "Relic Hunter Tier #092";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 92 * 1000;
        [SerializeField] private int prestigePoints = 92 * 10;
