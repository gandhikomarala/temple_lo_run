namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #001
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_001", menuName = "RelicRun/Achievements/Achievement #001")]
    public class AchievementDefinition_001 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_001";
        [SerializeField] private string badgeName = "Relic Hunter Tier #001";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 1 * 1000;
        [SerializeField] private int prestigePoints = 1 * 10;
