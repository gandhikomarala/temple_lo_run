namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #010
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_010", menuName = "RelicRun/Achievements/Achievement #010")]
    public class AchievementDefinition_010 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_010";
        [SerializeField] private string badgeName = "Relic Hunter Tier #010";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 10 * 1000;
        [SerializeField] private int prestigePoints = 10 * 10;
