namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #019
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_019", menuName = "RelicRun/Achievements/Achievement #019")]
    public class AchievementDefinition_019 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_019";
        [SerializeField] private string badgeName = "Relic Hunter Tier #019";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 19 * 1000;
        [SerializeField] private int prestigePoints = 19 * 10;
