namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #022
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_022", menuName = "RelicRun/Achievements/Achievement #022")]
    public class AchievementDefinition_022 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_022";
        [SerializeField] private string badgeName = "Relic Hunter Tier #022";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 22 * 1000;
        [SerializeField] private int prestigePoints = 22 * 10;
