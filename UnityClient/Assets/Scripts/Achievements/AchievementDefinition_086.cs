namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #086
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_086", menuName = "RelicRun/Achievements/Achievement #086")]
    public class AchievementDefinition_086 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_086";
        [SerializeField] private string badgeName = "Relic Hunter Tier #086";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 86 * 1000;
        [SerializeField] private int prestigePoints = 86 * 10;
