namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #064
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_064", menuName = "RelicRun/Achievements/Achievement #064")]
    public class AchievementDefinition_064 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_064";
        [SerializeField] private string badgeName = "Relic Hunter Tier #064";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 64 * 1000;
        [SerializeField] private int prestigePoints = 64 * 10;
