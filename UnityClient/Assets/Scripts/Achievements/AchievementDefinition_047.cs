namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #047
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_047", menuName = "RelicRun/Achievements/Achievement #047")]
    public class AchievementDefinition_047 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_047";
        [SerializeField] private string badgeName = "Relic Hunter Tier #047";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 47 * 1000;
        [SerializeField] private int prestigePoints = 47 * 10;
