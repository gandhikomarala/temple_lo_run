namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #065
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_065", menuName = "RelicRun/Achievements/Achievement #065")]
    public class AchievementDefinition_065 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_065";
        [SerializeField] private string badgeName = "Relic Hunter Tier #065";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 65 * 1000;
        [SerializeField] private int prestigePoints = 65 * 10;
