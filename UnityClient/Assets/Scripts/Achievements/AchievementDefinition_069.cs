namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #069
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_069", menuName = "RelicRun/Achievements/Achievement #069")]
    public class AchievementDefinition_069 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_069";
        [SerializeField] private string badgeName = "Relic Hunter Tier #069";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 69 * 1000;
        [SerializeField] private int prestigePoints = 69 * 10;
