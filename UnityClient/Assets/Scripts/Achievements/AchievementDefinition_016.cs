namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #016
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_016", menuName = "RelicRun/Achievements/Achievement #016")]
    public class AchievementDefinition_016 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_016";
        [SerializeField] private string badgeName = "Relic Hunter Tier #016";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 16 * 1000;
        [SerializeField] private int prestigePoints = 16 * 10;
