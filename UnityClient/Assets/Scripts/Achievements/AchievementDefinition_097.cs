namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #097
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_097", menuName = "RelicRun/Achievements/Achievement #097")]
    public class AchievementDefinition_097 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_097";
        [SerializeField] private string badgeName = "Relic Hunter Tier #097";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 97 * 1000;
        [SerializeField] private int prestigePoints = 97 * 10;
