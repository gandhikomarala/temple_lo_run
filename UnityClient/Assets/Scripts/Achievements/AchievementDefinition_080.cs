namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #080
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_080", menuName = "RelicRun/Achievements/Achievement #080")]
    public class AchievementDefinition_080 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_080";
        [SerializeField] private string badgeName = "Relic Hunter Tier #080";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 80 * 1000;
        [SerializeField] private int prestigePoints = 80 * 10;
