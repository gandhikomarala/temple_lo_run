namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #089
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_089", menuName = "RelicRun/Achievements/Achievement #089")]
    public class AchievementDefinition_089 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_089";
        [SerializeField] private string badgeName = "Relic Hunter Tier #089";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 89 * 1000;
        [SerializeField] private int prestigePoints = 89 * 10;
