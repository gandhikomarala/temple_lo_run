namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #093
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_093", menuName = "RelicRun/Achievements/Achievement #093")]
    public class AchievementDefinition_093 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_093";
        [SerializeField] private string badgeName = "Relic Hunter Tier #093";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 93 * 1000;
        [SerializeField] private int prestigePoints = 93 * 10;
