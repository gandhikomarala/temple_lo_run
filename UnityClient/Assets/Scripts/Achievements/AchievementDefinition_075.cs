namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #075
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_075", menuName = "RelicRun/Achievements/Achievement #075")]
    public class AchievementDefinition_075 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_075";
        [SerializeField] private string badgeName = "Relic Hunter Tier #075";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 75 * 1000;
        [SerializeField] private int prestigePoints = 75 * 10;
