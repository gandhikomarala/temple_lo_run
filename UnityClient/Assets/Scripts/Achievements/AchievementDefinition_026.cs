namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #026
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_026", menuName = "RelicRun/Achievements/Achievement #026")]
    public class AchievementDefinition_026 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_026";
        [SerializeField] private string badgeName = "Relic Hunter Tier #026";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 26 * 1000;
        [SerializeField] private int prestigePoints = 26 * 10;
