namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #023
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_023", menuName = "RelicRun/Achievements/Achievement #023")]
    public class AchievementDefinition_023 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_023";
        [SerializeField] private string badgeName = "Relic Hunter Tier #023";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 23 * 1000;
        [SerializeField] private int prestigePoints = 23 * 10;
