namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #055
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_055", menuName = "RelicRun/Achievements/Achievement #055")]
    public class AchievementDefinition_055 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_055";
        [SerializeField] private string badgeName = "Relic Hunter Tier #055";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 55 * 1000;
        [SerializeField] private int prestigePoints = 55 * 10;
