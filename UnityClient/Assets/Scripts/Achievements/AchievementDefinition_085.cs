namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #085
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_085", menuName = "RelicRun/Achievements/Achievement #085")]
    public class AchievementDefinition_085 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_085";
        [SerializeField] private string badgeName = "Relic Hunter Tier #085";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 85 * 1000;
        [SerializeField] private int prestigePoints = 85 * 10;
