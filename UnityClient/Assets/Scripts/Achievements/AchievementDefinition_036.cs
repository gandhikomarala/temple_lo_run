namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #036
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_036", menuName = "RelicRun/Achievements/Achievement #036")]
    public class AchievementDefinition_036 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_036";
        [SerializeField] private string badgeName = "Relic Hunter Tier #036";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 36 * 1000;
        [SerializeField] private int prestigePoints = 36 * 10;
