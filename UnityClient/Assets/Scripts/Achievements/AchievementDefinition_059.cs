namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #059
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_059", menuName = "RelicRun/Achievements/Achievement #059")]
    public class AchievementDefinition_059 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_059";
        [SerializeField] private string badgeName = "Relic Hunter Tier #059";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 59 * 1000;
        [SerializeField] private int prestigePoints = 59 * 10;
