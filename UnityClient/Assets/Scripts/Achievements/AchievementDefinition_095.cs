namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #095
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_095", menuName = "RelicRun/Achievements/Achievement #095")]
    public class AchievementDefinition_095 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_095";
        [SerializeField] private string badgeName = "Relic Hunter Tier #095";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 95 * 1000;
        [SerializeField] private int prestigePoints = 95 * 10;
