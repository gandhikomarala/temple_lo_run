namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #056
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_056", menuName = "RelicRun/Achievements/Achievement #056")]
    public class AchievementDefinition_056 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_056";
        [SerializeField] private string badgeName = "Relic Hunter Tier #056";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 56 * 1000;
        [SerializeField] private int prestigePoints = 56 * 10;
