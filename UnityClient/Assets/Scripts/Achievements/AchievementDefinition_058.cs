namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #058
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_058", menuName = "RelicRun/Achievements/Achievement #058")]
    public class AchievementDefinition_058 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_058";
        [SerializeField] private string badgeName = "Relic Hunter Tier #058";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 58 * 1000;
        [SerializeField] private int prestigePoints = 58 * 10;
