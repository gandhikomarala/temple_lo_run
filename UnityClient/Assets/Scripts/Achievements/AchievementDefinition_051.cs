namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #051
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_051", menuName = "RelicRun/Achievements/Achievement #051")]
    public class AchievementDefinition_051 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_051";
        [SerializeField] private string badgeName = "Relic Hunter Tier #051";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 51 * 1000;
        [SerializeField] private int prestigePoints = 51 * 10;
