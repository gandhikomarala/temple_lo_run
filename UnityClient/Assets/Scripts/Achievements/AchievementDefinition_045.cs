namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #045
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_045", menuName = "RelicRun/Achievements/Achievement #045")]
    public class AchievementDefinition_045 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_045";
        [SerializeField] private string badgeName = "Relic Hunter Tier #045";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 45 * 1000;
        [SerializeField] private int prestigePoints = 45 * 10;
