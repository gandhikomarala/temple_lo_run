namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #084
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_084", menuName = "RelicRun/Achievements/Achievement #084")]
    public class AchievementDefinition_084 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_084";
        [SerializeField] private string badgeName = "Relic Hunter Tier #084";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 84 * 1000;
        [SerializeField] private int prestigePoints = 84 * 10;
