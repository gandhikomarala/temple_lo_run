namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #041
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_041", menuName = "RelicRun/Achievements/Achievement #041")]
    public class AchievementDefinition_041 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_041";
        [SerializeField] private string badgeName = "Relic Hunter Tier #041";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 41 * 1000;
        [SerializeField] private int prestigePoints = 41 * 10;
