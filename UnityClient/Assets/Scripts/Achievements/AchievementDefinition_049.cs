namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #049
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_049", menuName = "RelicRun/Achievements/Achievement #049")]
    public class AchievementDefinition_049 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_049";
        [SerializeField] private string badgeName = "Relic Hunter Tier #049";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 49 * 1000;
        [SerializeField] private int prestigePoints = 49 * 10;
