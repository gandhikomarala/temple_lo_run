namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #094
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_094", menuName = "RelicRun/Achievements/Achievement #094")]
    public class AchievementDefinition_094 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_094";
        [SerializeField] private string badgeName = "Relic Hunter Tier #094";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 94 * 1000;
        [SerializeField] private int prestigePoints = 94 * 10;
