namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #083
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_083", menuName = "RelicRun/Achievements/Achievement #083")]
    public class AchievementDefinition_083 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_083";
        [SerializeField] private string badgeName = "Relic Hunter Tier #083";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 83 * 1000;
        [SerializeField] private int prestigePoints = 83 * 10;
