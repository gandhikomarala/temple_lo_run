namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #009
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_009", menuName = "RelicRun/Achievements/Achievement #009")]
    public class AchievementDefinition_009 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_009";
        [SerializeField] private string badgeName = "Relic Hunter Tier #009";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 9 * 1000;
        [SerializeField] private int prestigePoints = 9 * 10;
