namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #048
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_048", menuName = "RelicRun/Achievements/Achievement #048")]
    public class AchievementDefinition_048 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_048";
        [SerializeField] private string badgeName = "Relic Hunter Tier #048";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 48 * 1000;
        [SerializeField] private int prestigePoints = 48 * 10;
