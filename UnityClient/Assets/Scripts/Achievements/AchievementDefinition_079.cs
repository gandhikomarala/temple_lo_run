namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #079
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_079", menuName = "RelicRun/Achievements/Achievement #079")]
    public class AchievementDefinition_079 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_079";
        [SerializeField] private string badgeName = "Relic Hunter Tier #079";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 79 * 1000;
        [SerializeField] private int prestigePoints = 79 * 10;
