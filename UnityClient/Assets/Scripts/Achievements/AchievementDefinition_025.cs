namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #025
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_025", menuName = "RelicRun/Achievements/Achievement #025")]
    public class AchievementDefinition_025 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_025";
        [SerializeField] private string badgeName = "Relic Hunter Tier #025";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 25 * 1000;
        [SerializeField] private int prestigePoints = 25 * 10;
