namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #034
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_034", menuName = "RelicRun/Achievements/Achievement #034")]
    public class AchievementDefinition_034 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_034";
        [SerializeField] private string badgeName = "Relic Hunter Tier #034";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 34 * 1000;
        [SerializeField] private int prestigePoints = 34 * 10;
