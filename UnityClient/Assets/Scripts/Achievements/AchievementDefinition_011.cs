namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #011
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_011", menuName = "RelicRun/Achievements/Achievement #011")]
    public class AchievementDefinition_011 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_011";
        [SerializeField] private string badgeName = "Relic Hunter Tier #011";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 11 * 1000;
        [SerializeField] private int prestigePoints = 11 * 10;
