namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #017
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_017", menuName = "RelicRun/Achievements/Achievement #017")]
    public class AchievementDefinition_017 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_017";
        [SerializeField] private string badgeName = "Relic Hunter Tier #017";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 17 * 1000;
        [SerializeField] private int prestigePoints = 17 * 10;
