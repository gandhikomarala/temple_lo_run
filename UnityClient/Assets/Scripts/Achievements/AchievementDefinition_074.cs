namespace RelicRun.Achievements
{
    ...
    /// <summary>
    /// Master Achievement Definition #074
    /// Handles lifetime milestones, relic discovery badges, and prestige points.
    /// </summary>
    [CreateAssetMenu(fileName = "AchievementDefinition_074", menuName = "RelicRun/Achievements/Achievement #074")]
    public class AchievementDefinition_074 : ScriptableObject
    {
        [SerializeField] private string achievementId = "ACHIEVEMENT_074";
        [SerializeField] private string badgeName = "Relic Hunter Tier #074";
        [SerializeField] private string loreDescription = "Survive the collapsing ancient temple ruins.";
        [SerializeField] private int requiredLifetimeDistance = 74 * 1000;
        [SerializeField] private int prestigePoints = 74 * 10;
