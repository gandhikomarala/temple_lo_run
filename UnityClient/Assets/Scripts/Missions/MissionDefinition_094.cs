namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #094
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_094", menuName = "RelicRun/Missions/Mission #094")]
    public class MissionDefinition_094 : ScriptableObject
    {
        public enum MissionObjectiveType { CollectCoins, SurviveDistance, PerformJumps, PerformSlides, UsePowerUps }

        [SerializeField] private string missionId = "MISSION_094";
        [SerializeField] private string title = "Challenge #094";
        ...
        [SerializeField] private int targetAmount = 100 + (94 * 25);
        [SerializeField] private int rewardCoins = 250 + (94 * 50);
        [SerializeField] private int rewardStardust = 100 + (94 * 20);
