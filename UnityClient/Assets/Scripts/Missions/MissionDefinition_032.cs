namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #032
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_032", menuName = "RelicRun/Missions/Mission #032")]
    public class MissionDefinition_032 : ScriptableObject
    {
        public enum MissionObjectiveType { CollectCoins, SurviveDistance, PerformJumps, PerformSlides, UsePowerUps }

        [SerializeField] private string missionId = "MISSION_032";
        [SerializeField] private string title = "Challenge #032";
        ...
        [SerializeField] private int targetAmount = 100 + (32 * 25);
        [SerializeField] private int rewardCoins = 250 + (32 * 50);
        [SerializeField] private int rewardStardust = 100 + (32 * 20);
