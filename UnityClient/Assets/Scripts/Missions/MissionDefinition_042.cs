namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #042
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_042", menuName = "RelicRun/Missions/Mission #042")]
    public class MissionDefinition_042 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #042";
        ...
        [SerializeField] private int targetAmount = 100 + (42 * 25);
        [SerializeField] private int rewardCoins = 250 + (42 * 50);
        [SerializeField] private int rewardStardust = 100 + (42 * 20);
