namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #084
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_084", menuName = "RelicRun/Missions/Mission #084")]
    public class MissionDefinition_084 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #084";
        ...
        [SerializeField] private int targetAmount = 100 + (84 * 25);
        [SerializeField] private int rewardCoins = 250 + (84 * 50);
        [SerializeField] private int rewardStardust = 100 + (84 * 20);
