namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #098
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_098", menuName = "RelicRun/Missions/Mission #098")]
    public class MissionDefinition_098 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #098";
        ...
        [SerializeField] private int targetAmount = 100 + (98 * 25);
        [SerializeField] private int rewardCoins = 250 + (98 * 50);
        [SerializeField] private int rewardStardust = 100 + (98 * 20);
