namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #006
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_006", menuName = "RelicRun/Missions/Mission #006")]
    public class MissionDefinition_006 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #006";
        ...
        [SerializeField] private int targetAmount = 100 + (6 * 25);
        [SerializeField] private int rewardCoins = 250 + (6 * 50);
        [SerializeField] private int rewardStardust = 100 + (6 * 20);
