namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #067
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_067", menuName = "RelicRun/Missions/Mission #067")]
    public class MissionDefinition_067 : ScriptableObject
    {
        public enum MissionObjectiveType { CollectCoins, SurviveDistance, PerformJumps, PerformSlides, UsePowerUps }

        [SerializeField] private string missionId = "MISSION_067";
        [SerializeField] private string title = "Challenge #067";
        ...
        [SerializeField] private int targetAmount = 100 + (67 * 25);
        [SerializeField] private int rewardCoins = 250 + (67 * 50);
        [SerializeField] private int rewardStardust = 100 + (67 * 20);
