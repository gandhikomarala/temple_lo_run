namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #015
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_015", menuName = "RelicRun/Missions/Mission #015")]
    public class MissionDefinition_015 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #015";
        ...
        [SerializeField] private int targetAmount = 100 + (15 * 25);
        [SerializeField] private int rewardCoins = 250 + (15 * 50);
        [SerializeField] private int rewardStardust = 100 + (15 * 20);
