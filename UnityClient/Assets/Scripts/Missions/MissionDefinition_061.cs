namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #061
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_061", menuName = "RelicRun/Missions/Mission #061")]
    public class MissionDefinition_061 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #061";
        ...
        [SerializeField] private int targetAmount = 100 + (61 * 25);
        [SerializeField] private int rewardCoins = 250 + (61 * 50);
        [SerializeField] private int rewardStardust = 100 + (61 * 20);
