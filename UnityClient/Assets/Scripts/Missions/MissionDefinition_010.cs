namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #010
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_010", menuName = "RelicRun/Missions/Mission #010")]
    public class MissionDefinition_010 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #010";
        ...
        [SerializeField] private int targetAmount = 100 + (10 * 25);
        [SerializeField] private int rewardCoins = 250 + (10 * 50);
        [SerializeField] private int rewardStardust = 100 + (10 * 20);
