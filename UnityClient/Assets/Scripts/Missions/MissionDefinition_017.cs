namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #017
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_017", menuName = "RelicRun/Missions/Mission #017")]
    public class MissionDefinition_017 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #017";
        ...
        [SerializeField] private int targetAmount = 100 + (17 * 25);
        [SerializeField] private int rewardCoins = 250 + (17 * 50);
        [SerializeField] private int rewardStardust = 100 + (17 * 20);
