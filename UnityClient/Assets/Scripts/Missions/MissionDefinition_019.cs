namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #019
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_019", menuName = "RelicRun/Missions/Mission #019")]
    public class MissionDefinition_019 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #019";
        ...
        [SerializeField] private int targetAmount = 100 + (19 * 25);
        [SerializeField] private int rewardCoins = 250 + (19 * 50);
        [SerializeField] private int rewardStardust = 100 + (19 * 20);
