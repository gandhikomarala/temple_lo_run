namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #034
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_034", menuName = "RelicRun/Missions/Mission #034")]
    public class MissionDefinition_034 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #034";
        ...
        [SerializeField] private int targetAmount = 100 + (34 * 25);
        [SerializeField] private int rewardCoins = 250 + (34 * 50);
        [SerializeField] private int rewardStardust = 100 + (34 * 20);
