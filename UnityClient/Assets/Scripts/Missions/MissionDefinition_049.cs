namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #049
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_049", menuName = "RelicRun/Missions/Mission #049")]
    public class MissionDefinition_049 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #049";
        ...
        [SerializeField] private int targetAmount = 100 + (49 * 25);
        [SerializeField] private int rewardCoins = 250 + (49 * 50);
        [SerializeField] private int rewardStardust = 100 + (49 * 20);
