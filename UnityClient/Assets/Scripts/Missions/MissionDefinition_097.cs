namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #097
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_097", menuName = "RelicRun/Missions/Mission #097")]
    public class MissionDefinition_097 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #097";
        ...
        [SerializeField] private int targetAmount = 100 + (97 * 25);
        [SerializeField] private int rewardCoins = 250 + (97 * 50);
        [SerializeField] private int rewardStardust = 100 + (97 * 20);
