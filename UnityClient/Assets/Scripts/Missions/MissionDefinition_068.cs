namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #068
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_068", menuName = "RelicRun/Missions/Mission #068")]
    public class MissionDefinition_068 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #068";
        ...
        [SerializeField] private int targetAmount = 100 + (68 * 25);
        [SerializeField] private int rewardCoins = 250 + (68 * 50);
        [SerializeField] private int rewardStardust = 100 + (68 * 20);
