namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #037
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_037", menuName = "RelicRun/Missions/Mission #037")]
    public class MissionDefinition_037 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #037";
        ...
        [SerializeField] private int targetAmount = 100 + (37 * 25);
        [SerializeField] private int rewardCoins = 250 + (37 * 50);
        [SerializeField] private int rewardStardust = 100 + (37 * 20);
