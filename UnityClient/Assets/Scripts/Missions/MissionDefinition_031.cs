namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #031
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_031", menuName = "RelicRun/Missions/Mission #031")]
    public class MissionDefinition_031 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #031";
        ...
        [SerializeField] private int targetAmount = 100 + (31 * 25);
        [SerializeField] private int rewardCoins = 250 + (31 * 50);
        [SerializeField] private int rewardStardust = 100 + (31 * 20);
