namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #020
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_020", menuName = "RelicRun/Missions/Mission #020")]
    public class MissionDefinition_020 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #020";
        ...
        [SerializeField] private int targetAmount = 100 + (20 * 25);
        [SerializeField] private int rewardCoins = 250 + (20 * 50);
        [SerializeField] private int rewardStardust = 100 + (20 * 20);
