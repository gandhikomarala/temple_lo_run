namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #014
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_014", menuName = "RelicRun/Missions/Mission #014")]
    public class MissionDefinition_014 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #014";
        ...
        [SerializeField] private int targetAmount = 100 + (14 * 25);
        [SerializeField] private int rewardCoins = 250 + (14 * 50);
        [SerializeField] private int rewardStardust = 100 + (14 * 20);
