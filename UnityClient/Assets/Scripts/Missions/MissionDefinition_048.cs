namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #048
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_048", menuName = "RelicRun/Missions/Mission #048")]
    public class MissionDefinition_048 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #048";
        ...
        [SerializeField] private int targetAmount = 100 + (48 * 25);
        [SerializeField] private int rewardCoins = 250 + (48 * 50);
        [SerializeField] private int rewardStardust = 100 + (48 * 20);
