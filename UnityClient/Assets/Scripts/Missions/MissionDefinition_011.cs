namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #011
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_011", menuName = "RelicRun/Missions/Mission #011")]
    public class MissionDefinition_011 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #011";
        ...
        [SerializeField] private int targetAmount = 100 + (11 * 25);
        [SerializeField] private int rewardCoins = 250 + (11 * 50);
        [SerializeField] private int rewardStardust = 100 + (11 * 20);
