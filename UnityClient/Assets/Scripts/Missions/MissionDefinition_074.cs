namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #074
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_074", menuName = "RelicRun/Missions/Mission #074")]
    public class MissionDefinition_074 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #074";
        ...
        [SerializeField] private int targetAmount = 100 + (74 * 25);
        [SerializeField] private int rewardCoins = 250 + (74 * 50);
        [SerializeField] private int rewardStardust = 100 + (74 * 20);
