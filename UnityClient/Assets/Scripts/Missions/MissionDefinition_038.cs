namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #038
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_038", menuName = "RelicRun/Missions/Mission #038")]
    public class MissionDefinition_038 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #038";
        ...
        [SerializeField] private int targetAmount = 100 + (38 * 25);
        [SerializeField] private int rewardCoins = 250 + (38 * 50);
        [SerializeField] private int rewardStardust = 100 + (38 * 20);
