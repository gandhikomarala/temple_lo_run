namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #016
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_016", menuName = "RelicRun/Missions/Mission #016")]
    public class MissionDefinition_016 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #016";
        ...
        [SerializeField] private int targetAmount = 100 + (16 * 25);
        [SerializeField] private int rewardCoins = 250 + (16 * 50);
        [SerializeField] private int rewardStardust = 100 + (16 * 20);
