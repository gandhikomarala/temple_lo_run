namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #027
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_027", menuName = "RelicRun/Missions/Mission #027")]
    public class MissionDefinition_027 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #027";
        ...
        [SerializeField] private int targetAmount = 100 + (27 * 25);
        [SerializeField] private int rewardCoins = 250 + (27 * 50);
        [SerializeField] private int rewardStardust = 100 + (27 * 20);
