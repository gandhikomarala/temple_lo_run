namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #008
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_008", menuName = "RelicRun/Missions/Mission #008")]
    public class MissionDefinition_008 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #008";
        ...
        [SerializeField] private int targetAmount = 100 + (8 * 25);
        [SerializeField] private int rewardCoins = 250 + (8 * 50);
        [SerializeField] private int rewardStardust = 100 + (8 * 20);
