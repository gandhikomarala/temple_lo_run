namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #057
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_057", menuName = "RelicRun/Missions/Mission #057")]
    public class MissionDefinition_057 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #057";
        ...
        [SerializeField] private int targetAmount = 100 + (57 * 25);
        [SerializeField] private int rewardCoins = 250 + (57 * 50);
        [SerializeField] private int rewardStardust = 100 + (57 * 20);
