namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #089
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_089", menuName = "RelicRun/Missions/Mission #089")]
    public class MissionDefinition_089 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #089";
        ...
        [SerializeField] private int targetAmount = 100 + (89 * 25);
        [SerializeField] private int rewardCoins = 250 + (89 * 50);
        [SerializeField] private int rewardStardust = 100 + (89 * 20);
