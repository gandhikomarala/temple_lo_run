namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #024
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_024", menuName = "RelicRun/Missions/Mission #024")]
    public class MissionDefinition_024 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #024";
        ...
        [SerializeField] private int targetAmount = 100 + (24 * 25);
        [SerializeField] private int rewardCoins = 250 + (24 * 50);
        [SerializeField] private int rewardStardust = 100 + (24 * 20);
