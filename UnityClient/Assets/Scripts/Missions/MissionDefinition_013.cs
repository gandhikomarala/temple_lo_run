namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #013
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_013", menuName = "RelicRun/Missions/Mission #013")]
    public class MissionDefinition_013 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #013";
        ...
        [SerializeField] private int targetAmount = 100 + (13 * 25);
        [SerializeField] private int rewardCoins = 250 + (13 * 50);
        [SerializeField] private int rewardStardust = 100 + (13 * 20);
