namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #045
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_045", menuName = "RelicRun/Missions/Mission #045")]
    public class MissionDefinition_045 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #045";
        ...
        [SerializeField] private int targetAmount = 100 + (45 * 25);
        [SerializeField] private int rewardCoins = 250 + (45 * 50);
        [SerializeField] private int rewardStardust = 100 + (45 * 20);
