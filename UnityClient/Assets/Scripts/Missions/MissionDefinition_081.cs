namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #081
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_081", menuName = "RelicRun/Missions/Mission #081")]
    public class MissionDefinition_081 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #081";
        ...
        [SerializeField] private int targetAmount = 100 + (81 * 25);
        [SerializeField] private int rewardCoins = 250 + (81 * 50);
        [SerializeField] private int rewardStardust = 100 + (81 * 20);
