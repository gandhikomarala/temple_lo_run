namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #022
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_022", menuName = "RelicRun/Missions/Mission #022")]
    public class MissionDefinition_022 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #022";
        ...
        [SerializeField] private int targetAmount = 100 + (22 * 25);
        [SerializeField] private int rewardCoins = 250 + (22 * 50);
        [SerializeField] private int rewardStardust = 100 + (22 * 20);
