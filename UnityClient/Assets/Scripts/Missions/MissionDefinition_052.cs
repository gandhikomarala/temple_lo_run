namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #052
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_052", menuName = "RelicRun/Missions/Mission #052")]
    public class MissionDefinition_052 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #052";
        ...
        [SerializeField] private int targetAmount = 100 + (52 * 25);
        [SerializeField] private int rewardCoins = 250 + (52 * 50);
        [SerializeField] private int rewardStardust = 100 + (52 * 20);
