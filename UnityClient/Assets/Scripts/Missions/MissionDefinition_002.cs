namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #002
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_002", menuName = "RelicRun/Missions/Mission #002")]
    public class MissionDefinition_002 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #002";
        ...
        [SerializeField] private int targetAmount = 100 + (2 * 25);
        [SerializeField] private int rewardCoins = 250 + (2 * 50);
        [SerializeField] private int rewardStardust = 100 + (2 * 20);
