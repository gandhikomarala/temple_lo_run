namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #080
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_080", menuName = "RelicRun/Missions/Mission #080")]
    public class MissionDefinition_080 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #080";
        ...
        [SerializeField] private int targetAmount = 100 + (80 * 25);
        [SerializeField] private int rewardCoins = 250 + (80 * 50);
        [SerializeField] private int rewardStardust = 100 + (80 * 20);
