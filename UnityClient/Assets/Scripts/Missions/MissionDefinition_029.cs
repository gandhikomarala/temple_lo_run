namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #029
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_029", menuName = "RelicRun/Missions/Mission #029")]
    public class MissionDefinition_029 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #029";
        ...
        [SerializeField] private int targetAmount = 100 + (29 * 25);
        [SerializeField] private int rewardCoins = 250 + (29 * 50);
        [SerializeField] private int rewardStardust = 100 + (29 * 20);
