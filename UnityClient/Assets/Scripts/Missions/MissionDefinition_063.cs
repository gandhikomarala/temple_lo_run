namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #063
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_063", menuName = "RelicRun/Missions/Mission #063")]
    public class MissionDefinition_063 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #063";
        ...
        [SerializeField] private int targetAmount = 100 + (63 * 25);
        [SerializeField] private int rewardCoins = 250 + (63 * 50);
        [SerializeField] private int rewardStardust = 100 + (63 * 20);
