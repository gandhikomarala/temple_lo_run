namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #088
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_088", menuName = "RelicRun/Missions/Mission #088")]
    public class MissionDefinition_088 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #088";
        ...
        [SerializeField] private int targetAmount = 100 + (88 * 25);
        [SerializeField] private int rewardCoins = 250 + (88 * 50);
        [SerializeField] private int rewardStardust = 100 + (88 * 20);
