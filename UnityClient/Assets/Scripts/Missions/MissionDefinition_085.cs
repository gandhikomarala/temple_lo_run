namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #085
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_085", menuName = "RelicRun/Missions/Mission #085")]
    public class MissionDefinition_085 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #085";
        ...
        [SerializeField] private int targetAmount = 100 + (85 * 25);
        [SerializeField] private int rewardCoins = 250 + (85 * 50);
        [SerializeField] private int rewardStardust = 100 + (85 * 20);
