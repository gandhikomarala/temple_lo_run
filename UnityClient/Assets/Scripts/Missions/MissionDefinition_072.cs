namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #072
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_072", menuName = "RelicRun/Missions/Mission #072")]
    public class MissionDefinition_072 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #072";
        ...
        [SerializeField] private int targetAmount = 100 + (72 * 25);
        [SerializeField] private int rewardCoins = 250 + (72 * 50);
        [SerializeField] private int rewardStardust = 100 + (72 * 20);
