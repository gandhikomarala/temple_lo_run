namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #069
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_069", menuName = "RelicRun/Missions/Mission #069")]
    public class MissionDefinition_069 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #069";
        ...
        [SerializeField] private int targetAmount = 100 + (69 * 25);
        [SerializeField] private int rewardCoins = 250 + (69 * 50);
        [SerializeField] private int rewardStardust = 100 + (69 * 20);
