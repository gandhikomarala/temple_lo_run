namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #071
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_071", menuName = "RelicRun/Missions/Mission #071")]
    public class MissionDefinition_071 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #071";
        ...
        [SerializeField] private int targetAmount = 100 + (71 * 25);
        [SerializeField] private int rewardCoins = 250 + (71 * 50);
        [SerializeField] private int rewardStardust = 100 + (71 * 20);
