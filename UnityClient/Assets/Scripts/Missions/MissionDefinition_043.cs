namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #043
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_043", menuName = "RelicRun/Missions/Mission #043")]
    public class MissionDefinition_043 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #043";
        ...
        [SerializeField] private int targetAmount = 100 + (43 * 25);
        [SerializeField] private int rewardCoins = 250 + (43 * 50);
        [SerializeField] private int rewardStardust = 100 + (43 * 20);
