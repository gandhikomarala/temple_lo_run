namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #070
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_070", menuName = "RelicRun/Missions/Mission #070")]
    public class MissionDefinition_070 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #070";
        ...
        [SerializeField] private int targetAmount = 100 + (70 * 25);
        [SerializeField] private int rewardCoins = 250 + (70 * 50);
        [SerializeField] private int rewardStardust = 100 + (70 * 20);
