namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #050
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_050", menuName = "RelicRun/Missions/Mission #050")]
    public class MissionDefinition_050 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #050";
        ...
        [SerializeField] private int targetAmount = 100 + (50 * 25);
        [SerializeField] private int rewardCoins = 250 + (50 * 50);
        [SerializeField] private int rewardStardust = 100 + (50 * 20);
