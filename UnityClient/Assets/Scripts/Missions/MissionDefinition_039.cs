namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #039
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_039", menuName = "RelicRun/Missions/Mission #039")]
    public class MissionDefinition_039 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #039";
        ...
        [SerializeField] private int targetAmount = 100 + (39 * 25);
        [SerializeField] private int rewardCoins = 250 + (39 * 50);
        [SerializeField] private int rewardStardust = 100 + (39 * 20);
