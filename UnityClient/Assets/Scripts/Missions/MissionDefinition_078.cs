namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #078
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_078", menuName = "RelicRun/Missions/Mission #078")]
    public class MissionDefinition_078 : ScriptableObject
    {
        public enum MissionObjectiveType { CollectCoins, SurviveDistance, PerformJumps, PerformSlides, UsePowerUps }

        [SerializeField] private string missionId = "MISSION_078";
        [SerializeField] private string title = "Challenge #078";
        ...
        [SerializeField] private int targetAmount = 100 + (78 * 25);
        [SerializeField] private int rewardCoins = 250 + (78 * 50);
        [SerializeField] private int rewardStardust = 100 + (78 * 20);
