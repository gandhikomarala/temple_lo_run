namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #095
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_095", menuName = "RelicRun/Missions/Mission #095")]
    public class MissionDefinition_095 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #095";
        ...
        [SerializeField] private int targetAmount = 100 + (95 * 25);
        [SerializeField] private int rewardCoins = 250 + (95 * 50);
        [SerializeField] private int rewardStardust = 100 + (95 * 20);
