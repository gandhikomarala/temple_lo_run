namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #005
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_005", menuName = "RelicRun/Missions/Mission #005")]
    public class MissionDefinition_005 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #005";
        ...
        [SerializeField] private int targetAmount = 100 + (5 * 25);
        [SerializeField] private int rewardCoins = 250 + (5 * 50);
        [SerializeField] private int rewardStardust = 100 + (5 * 20);
