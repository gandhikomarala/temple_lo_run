namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #100
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_100", menuName = "RelicRun/Missions/Mission #100")]
    public class MissionDefinition_100 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #100";
        ...
        [SerializeField] private int targetAmount = 100 + (100 * 25);
        [SerializeField] private int rewardCoins = 250 + (100 * 50);
        [SerializeField] private int rewardStardust = 100 + (100 * 20);
