namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #047
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_047", menuName = "RelicRun/Missions/Mission #047")]
    public class MissionDefinition_047 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #047";
        ...
        [SerializeField] private int targetAmount = 100 + (47 * 25);
        [SerializeField] private int rewardCoins = 250 + (47 * 50);
        [SerializeField] private int rewardStardust = 100 + (47 * 20);
