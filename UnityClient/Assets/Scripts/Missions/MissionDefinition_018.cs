namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #018
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_018", menuName = "RelicRun/Missions/Mission #018")]
    public class MissionDefinition_018 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #018";
        ...
        [SerializeField] private int targetAmount = 100 + (18 * 25);
        [SerializeField] private int rewardCoins = 250 + (18 * 50);
        [SerializeField] private int rewardStardust = 100 + (18 * 20);
