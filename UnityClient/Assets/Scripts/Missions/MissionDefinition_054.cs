namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #054
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_054", menuName = "RelicRun/Missions/Mission #054")]
    public class MissionDefinition_054 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #054";
        ...
        [SerializeField] private int targetAmount = 100 + (54 * 25);
        [SerializeField] private int rewardCoins = 250 + (54 * 50);
        [SerializeField] private int rewardStardust = 100 + (54 * 20);
