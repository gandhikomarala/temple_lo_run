namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #096
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_096", menuName = "RelicRun/Missions/Mission #096")]
    public class MissionDefinition_096 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #096";
        ...
        [SerializeField] private int targetAmount = 100 + (96 * 25);
        [SerializeField] private int rewardCoins = 250 + (96 * 50);
        [SerializeField] private int rewardStardust = 100 + (96 * 20);
