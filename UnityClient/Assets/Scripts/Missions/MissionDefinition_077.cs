namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #077
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_077", menuName = "RelicRun/Missions/Mission #077")]
    public class MissionDefinition_077 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #077";
        ...
        [SerializeField] private int targetAmount = 100 + (77 * 25);
        [SerializeField] private int rewardCoins = 250 + (77 * 50);
        [SerializeField] private int rewardStardust = 100 + (77 * 20);
