namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #091
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_091", menuName = "RelicRun/Missions/Mission #091")]
    public class MissionDefinition_091 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #091";
        ...
        [SerializeField] private int targetAmount = 100 + (91 * 25);
        [SerializeField] private int rewardCoins = 250 + (91 * 50);
        [SerializeField] private int rewardStardust = 100 + (91 * 20);
