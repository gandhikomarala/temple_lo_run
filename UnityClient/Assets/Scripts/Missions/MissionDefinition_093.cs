namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #093
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_093", menuName = "RelicRun/Missions/Mission #093")]
    public class MissionDefinition_093 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #093";
        ...
        [SerializeField] private int targetAmount = 100 + (93 * 25);
        [SerializeField] private int rewardCoins = 250 + (93 * 50);
        [SerializeField] private int rewardStardust = 100 + (93 * 20);
