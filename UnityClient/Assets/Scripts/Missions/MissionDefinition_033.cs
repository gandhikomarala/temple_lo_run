namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #033
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_033", menuName = "RelicRun/Missions/Mission #033")]
    public class MissionDefinition_033 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #033";
        ...
        [SerializeField] private int targetAmount = 100 + (33 * 25);
        [SerializeField] private int rewardCoins = 250 + (33 * 50);
        [SerializeField] private int rewardStardust = 100 + (33 * 20);
