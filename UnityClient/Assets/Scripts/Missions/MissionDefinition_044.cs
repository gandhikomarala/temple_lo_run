namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #044
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_044", menuName = "RelicRun/Missions/Mission #044")]
    public class MissionDefinition_044 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #044";
        ...
        [SerializeField] private int targetAmount = 100 + (44 * 25);
        [SerializeField] private int rewardCoins = 250 + (44 * 50);
        [SerializeField] private int rewardStardust = 100 + (44 * 20);
