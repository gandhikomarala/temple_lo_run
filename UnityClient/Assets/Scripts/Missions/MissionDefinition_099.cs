namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #099
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_099", menuName = "RelicRun/Missions/Mission #099")]
    public class MissionDefinition_099 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #099";
        ...
        [SerializeField] private int targetAmount = 100 + (99 * 25);
        [SerializeField] private int rewardCoins = 250 + (99 * 50);
        [SerializeField] private int rewardStardust = 100 + (99 * 20);
