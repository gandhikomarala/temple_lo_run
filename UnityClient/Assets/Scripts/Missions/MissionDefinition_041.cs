namespace RelicRun.Missions
{
    ...
    /// <summary>
    /// Dynamic Mission Definition #041
    /// Defines repeatable objectives, progress conditions, and currency rewards.
    /// </summary>
    [CreateAssetMenu(fileName = "MissionDefinition_041", menuName = "RelicRun/Missions/Mission #041")]
    public class MissionDefinition_041 : ScriptableObject
    {
        ...
        [SerializeField] private string title = "Challenge #041";
        ...
        [SerializeField] private int targetAmount = 100 + (41 * 25);
        [SerializeField] private int rewardCoins = 250 + (41 * 50);
        [SerializeField] private int rewardStardust = 100 + (41 * 20);
